...
export class AuthV1Api extends runtime.BaseAPI {
    ...
    async changePasswordRaw(
        ...
        if (
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling changePassword."
            );
        }
    ...
    async resetPasswordRaw(
        ...
        if (
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling resetPassword."
            );
        }
     ...
     */
    async resetPasswordConfirmRaw(
        requestParameters: ResetPasswordConfirmRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<V1Auth>> {
        if (
            requestParameters.body === null ||
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling resetPasswordConfirm."
            );
        }
    ...
    async resetPasswordConfirm(
        ...
        const response = await this.resetPasswordConfirmRaw(
            requestParameters,
            initOverrides
        );
        return await response.value();
    ...
    async signupRaw(
        ...
        if (
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling signup."
            );
        }
     ...
     */
    async trialRaw(
        requestParameters: TrialRequest,
        initOverrides?: RequestInit | runtime.InitOverrideFunction
    ): Promise<runtime.ApiResponse<void>> {
        if (
            requestParameters.body === null ||
            ...
            throw new runtime.RequiredError(
                "body",
                "Required parameter requestParameters.body was null or undefined when calling trial."
            );
        }
