...
export function V1IntervalScheduleFromJSONTyped(
    json: any,
    ...
    return {
        ...
        dependsOnPast: !exists(json, "dependsOnPast")
            ? undefined
            : json["dependsOnPast"],
    };
}

export function V1IntervalScheduleToJSON(
    value?: V1IntervalSchedule | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        endAt:
            value.endAt === undefined ? undefined : value.endAt.toISOString(),
