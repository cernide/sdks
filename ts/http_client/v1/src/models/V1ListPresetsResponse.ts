...
export function V1ListPresetsResponseFromJSON(
    json: any
): V1ListPresetsResponse {
    return V1ListPresetsResponseFromJSONTyped(json, false);
}

export function V1ListPresetsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1PresetFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListPresetsResponseToJSON(
    value?: V1ListPresetsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1PresetToJSON),
