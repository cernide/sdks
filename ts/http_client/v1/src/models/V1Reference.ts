...
export function V1ReferenceFromJSONTyped(
    json: any,
    ...
    return {
        hubRef: !exists(json, "hubRef")
            ? undefined
            : V1HubRefFromJSON(json["hubRef"]),
        dagRef: !exists(json, "dagRef")
            ? undefined
            : V1DagRefFromJSON(json["dagRef"]),
        urlRef: !exists(json, "urlRef")
            ? undefined
            : V1UrlRefFromJSON(json["urlRef"]),
        pathRef: !exists(json, "pathRef")
            ? undefined
            : V1PathRefFromJSON(json["pathRef"]),
    };
}
