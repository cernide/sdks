...
export function V1ConnectionSchemaFromJSONTyped(
    json: any,
    ...
    return {
        bucketConnection: !exists(json, "bucketConnection")
            ? undefined
            : V1BucketConnectionFromJSON(json["bucketConnection"]),
        hostPathConnection: !exists(json, "hostPathConnection")
            ? undefined
            : V1HostPathConnectionFromJSON(json["hostPathConnection"]),
        claimConnection: !exists(json, "claimConnection")
            ? undefined
            : V1ClaimConnectionFromJSON(json["claimConnection"]),
        hostConnection: !exists(json, "hostConnection")
            ? undefined
            : V1HostConnectionFromJSON(json["hostConnection"]),
        gitConnection: !exists(json, "gitConnection")
            ? undefined
            : V1GitConnectionFromJSON(json["gitConnection"]),
    };
}

export function V1ConnectionSchemaToJSON(
    value?: V1ConnectionSchema | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        hostPathConnection: V1HostPathConnectionToJSON(
            value.hostPathConnection
        ),
