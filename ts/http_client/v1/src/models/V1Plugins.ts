...
export function V1PluginsFromJSONTyped(
    json: any,
    ...
    return {
        ...
        mountArtifactsStore: !exists(json, "mountArtifactsStore")
            ? undefined
            : json["mountArtifactsStore"],
        collectArtifacts: !exists(json, "collectArtifacts")
            ? undefined
            : json["collectArtifacts"],
        collectLogs: !exists(json, "collectLogs")
            ? undefined
            : json["collectLogs"],
        collectResources: !exists(json, "collectResources")
            ? undefined
            : json["collectResources"],
        syncStatuses: !exists(json, "syncStatuses")
            ? undefined
            : json["syncStatuses"],
        autoResume: !exists(json, "autoResume")
            ? undefined
            : json["autoResume"],
        logLevel: !exists(json, "logLevel") ? undefined : json["logLevel"],
        externalHost: !exists(json, "externalHost")
            ? undefined
            : json["externalHost"],
        sidecar: !exists(json, "sidecar")
            ? undefined
            : V1PolyaxonSidecarContainerFromJSON(json["sidecar"]),
        notifications: !exists(json, "notifications")
            ? undefined
            : (json["notifications"] as Array<any>).map(V1NotificationFromJSON),
    };
}
    ...
    return {
        ...
        notifications:
            value.notifications === undefined
                ? undefined
                : (value.notifications as Array<any>).map(V1NotificationToJSON),
    };
}
