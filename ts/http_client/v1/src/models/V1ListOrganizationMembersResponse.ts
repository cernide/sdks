 ...
 */
export function instanceOfV1ListOrganizationMembersResponse(
    value: object
): boolean {
    let isInstance = true;
...
export function V1ListOrganizationMembersResponseFromJSON(
    json: any
): V1ListOrganizationMembersResponse {
    return V1ListOrganizationMembersResponseFromJSONTyped(json, false);
}

export function V1ListOrganizationMembersResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1OrganizationMemberFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListOrganizationMembersResponseToJSON(
    value?: V1ListOrganizationMembersResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1OrganizationMemberToJSON),
