...
export function V1EnvironmentFromJSONTyped(
    json: any,
    ...
    return {
        ...
        hostNetwork: !exists(json, "hostNetwork")
            ? undefined
            : json["hostNetwork"],
        ...
        schedulerName: !exists(json, "schedulerName")
            ? undefined
            : json["schedulerName"],
        priorityClassName: !exists(json, "priorityClassName")
            ? undefined
            : json["priorityClassName"],
        priority: !exists(json, "priority") ? undefined : json["priority"],
        restartPolicy: !exists(json, "restartPolicy")
            ? undefined
            : json["restartPolicy"],
    };
}
