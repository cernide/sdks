...
export function V1PytorchElasticPolicyFromJSON(
    json: any
): V1PytorchElasticPolicy {
    return V1PytorchElasticPolicyFromJSONTyped(json, false);
}

export function V1PytorchElasticPolicyFromJSONTyped(
    json: any,
    ...
    return {
        minReplicas: !exists(json, "minReplicas")
            ? undefined
            : json["minReplicas"],
        maxReplicas: !exists(json, "maxReplicas")
            ? undefined
            : json["maxReplicas"],
        rdvzBackend: !exists(json, "rdvzBackend")
            ? undefined
            : json["rdvzBackend"],
        ...
        standalone: !exists(json, "standalone")
            ? undefined
            : json["standalone"],
        nProcPerNode: !exists(json, "nProcPerNode")
            ? undefined
            : json["nProcPerNode"],
        maxRestarts: !exists(json, "maxRestarts")
            ? undefined
            : json["maxRestarts"],
...
export function V1PytorchElasticPolicyToJSON(
    value?: V1PytorchElasticPolicy | null
): any {
    if (value === undefined) {
        return undefined;
    }
