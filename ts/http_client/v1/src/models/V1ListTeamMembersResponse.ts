...
export function V1ListTeamMembersResponseFromJSON(
    json: any
): V1ListTeamMembersResponse {
    return V1ListTeamMembersResponseFromJSONTyped(json, false);
}

export function V1ListTeamMembersResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1TeamMemberFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListTeamMembersResponseToJSON(
    value?: V1ListTeamMembersResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1TeamMemberToJSON),
