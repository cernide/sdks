...
export function V1ListPoliciesResponseFromJSON(
    json: any
): V1ListPoliciesResponse {
    return V1ListPoliciesResponseFromJSONTyped(json, false);
}

export function V1ListPoliciesResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1PolicyFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListPoliciesResponseToJSON(
    value?: V1ListPoliciesResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1PolicyToJSON),
