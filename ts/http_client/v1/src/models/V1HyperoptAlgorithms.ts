...
export type V1HyperoptAlgorithms =
    (typeof V1HyperoptAlgorithms)[keyof typeof V1HyperoptAlgorithms];
...
export function V1HyperoptAlgorithmsFromJSONTyped(
    json: any,
...
export function V1HyperoptAlgorithmsToJSON(
    value?: V1HyperoptAlgorithms | null
): any {
    return value as any;
}
