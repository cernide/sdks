...
export function V1ConnectionResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        kind: !exists(json, "kind")
            ? undefined
            : V1ConnectionKindFromJSON(json["kind"]),
    };
}

export function V1ConnectionResponseToJSON(
    value?: V1ConnectionResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
