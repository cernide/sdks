...
export function V1MatrixFromJSONTyped(
    json: any,
    ...
    return {
        random: !exists(json, "random")
            ? undefined
            : V1RandomSearchFromJSON(json["random"]),
        grid: !exists(json, "grid")
            ? undefined
            : V1GridSearchFromJSON(json["grid"]),
        hyperband: !exists(json, "hyperband")
            ? undefined
            : V1HyperbandFromJSON(json["hyperband"]),
        bayes: !exists(json, "bayes")
            ? undefined
            : V1BayesFromJSON(json["bayes"]),
        hyperopt: !exists(json, "hyperopt")
            ? undefined
            : V1HyperoptFromJSON(json["hyperopt"]),
        iterative: !exists(json, "iterative")
            ? undefined
            : V1IterativeFromJSON(json["iterative"]),
        mapping: !exists(json, "mapping")
            ? undefined
            : V1MappingFromJSON(json["mapping"]),
    };
}
