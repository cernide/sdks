...
export function V1ListRunsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1RunFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListRunsResponseToJSON(
    value?: V1ListRunsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1RunToJSON),
