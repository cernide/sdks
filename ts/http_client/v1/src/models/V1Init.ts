...
export function V1InitFromJSONTyped(
    json: any,
    ...
    return {
        artifacts: !exists(json, "artifacts")
            ? undefined
            : V1ArtifactsTypeFromJSON(json["artifacts"]),
        paths: !exists(json, "paths") ? undefined : json["paths"],
        git: !exists(json, "git") ? undefined : V1GitTypeFromJSON(json["git"]),
        dockerfile: !exists(json, "dockerfile")
            ? undefined
            : V1DockerfileTypeFromJSON(json["dockerfile"]),
        file: !exists(json, "file")
            ? undefined
            : V1FileTypeFromJSON(json["file"]),
        tensorboard: !exists(json, "tensorboard")
            ? undefined
            : V1TensorboardTypeFromJSON(json["tensorboard"]),
        lineageRef: !exists(json, "lineageRef")
            ? undefined
            : json["lineageRef"],
        artifactRef: !exists(json, "artifactRef")
            ? undefined
            : json["artifactRef"],
