 ...
 */
export function instanceOfV1ListServiceAccountsResponse(
    value: object
): boolean {
    let isInstance = true;
...
export function V1ListServiceAccountsResponseFromJSON(
    json: any
): V1ListServiceAccountsResponse {
    return V1ListServiceAccountsResponseFromJSONTyped(json, false);
}

export function V1ListServiceAccountsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1ServiceAccountFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListServiceAccountsResponseToJSON(
    value?: V1ListServiceAccountsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1ServiceAccountToJSON),
