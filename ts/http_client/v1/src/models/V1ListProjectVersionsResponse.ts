 ...
 */
export function instanceOfV1ListProjectVersionsResponse(
    value: object
): boolean {
    let isInstance = true;
...
export function V1ListProjectVersionsResponseFromJSON(
    json: any
): V1ListProjectVersionsResponse {
    return V1ListProjectVersionsResponseFromJSONTyped(json, false);
}

export function V1ListProjectVersionsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1ProjectVersionFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListProjectVersionsResponseToJSON(
    value?: V1ListProjectVersionsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1ProjectVersionToJSON),
