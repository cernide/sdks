...
export function V1ListProjectsResponseFromJSON(
    json: any
): V1ListProjectsResponse {
    return V1ListProjectsResponseFromJSONTyped(json, false);
}

export function V1ListProjectsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1ProjectFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListProjectsResponseToJSON(
    value?: V1ListProjectsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1ProjectToJSON),
