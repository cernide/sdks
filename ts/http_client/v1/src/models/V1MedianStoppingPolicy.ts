...
export function V1MedianStoppingPolicyFromJSON(
    json: any
): V1MedianStoppingPolicy {
    return V1MedianStoppingPolicyFromJSONTyped(json, false);
}

export function V1MedianStoppingPolicyFromJSONTyped(
    json: any,
...
export function V1MedianStoppingPolicyToJSON(
    value?: V1MedianStoppingPolicy | null
): any {
    if (value === undefined) {
        return undefined;
    }
