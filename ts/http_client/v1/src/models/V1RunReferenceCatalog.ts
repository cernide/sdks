...
export function V1RunReferenceCatalogFromJSON(
    json: any
): V1RunReferenceCatalog {
    return V1RunReferenceCatalogFromJSONTyped(json, false);
}

export function V1RunReferenceCatalogFromJSONTyped(
    json: any,
...
export function V1RunReferenceCatalogToJSON(
    value?: V1RunReferenceCatalog | null
): any {
    if (value === undefined) {
        return undefined;
    }
