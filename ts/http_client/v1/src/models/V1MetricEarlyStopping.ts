...
export function V1MetricEarlyStoppingFromJSON(
    json: any
): V1MetricEarlyStopping {
    return V1MetricEarlyStoppingFromJSONTyped(json, false);
}

export function V1MetricEarlyStoppingFromJSONTyped(
    json: any,
    ...
    return {
        ...
        optimization: !exists(json, "optimization")
            ? undefined
            : V1OptimizationFromJSON(json["optimization"]),
        policy: !exists(json, "policy") ? undefined : json["policy"],
    };
}

export function V1MetricEarlyStoppingToJSON(
    value?: V1MetricEarlyStopping | null
): any {
    if (value === undefined) {
        return undefined;
    }
