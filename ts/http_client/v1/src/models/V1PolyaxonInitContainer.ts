...
export function V1PolyaxonInitContainerFromJSON(
    json: any
): V1PolyaxonInitContainer {
    return V1PolyaxonInitContainerFromJSONTyped(json, false);
}

export function V1PolyaxonInitContainerFromJSONTyped(
    json: any,
...
export function V1PolyaxonInitContainerToJSON(
    value?: V1PolyaxonInitContainer | null
): any {
    if (value === undefined) {
        return undefined;
    }
