...
export function V1EventConfusionMatrixFromJSON(
    json: any
): V1EventConfusionMatrix {
    return V1EventConfusionMatrixFromJSONTyped(json, false);
}

export function V1EventConfusionMatrixFromJSONTyped(
    json: any,
...
export function V1EventConfusionMatrixToJSON(
    value?: V1EventConfusionMatrix | null
): any {
    if (value === undefined) {
        return undefined;
    }
