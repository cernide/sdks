...
export function V1OperationFromJSONTyped(
    json: any,
    ...
    return {
        ...
        params: !exists(json, "params")
            ? undefined
            : mapValues(json["params"], V1ParamFromJSON),
        runPatch: !exists(json, "runPatch") ? undefined : json["runPatch"],
        patchStrategy: !exists(json, "patchStrategy")
            ? undefined
            : V1PatchStrategyFromJSON(json["patchStrategy"]),
        ...
        template: !exists(json, "template")
            ? undefined
            : V1TemplateFromJSON(json["template"]),
        ...
        component: !exists(json, "component")
            ? undefined
            : V1ComponentFromJSON(json["component"]),
    };
}
    ...
    return {
        ...
        params:
            value.params === undefined
                ? undefined
                : mapValues(value.params, V1ParamToJSON),
