...
export function V1PytorchJobFromJSONTyped(
    json: any,
    ...
    return {
        ...
        elasticPolicy: !exists(json, "elasticPolicy")
            ? undefined
            : V1PytorchElasticPolicyFromJSON(json["elasticPolicy"]),
        master: !exists(json, "master")
            ? undefined
            : V1KFReplicaFromJSON(json["master"]),
        worker: !exists(json, "worker")
            ? undefined
            : V1KFReplicaFromJSON(json["worker"]),
        nProcPerNode: !exists(json, "nProcPerNode")
            ? undefined
            : json["nProcPerNode"],
    };
}
