...
export function V1SchedulingPolicyFromJSONTyped(
    json: any,
    ...
    return {
        minAvailable: !exists(json, "minAvailable")
            ? undefined
            : json["minAvailable"],
        queue: !exists(json, "queue") ? undefined : json["queue"],
        minResources: !exists(json, "minResources")
            ? undefined
            : json["minResources"],
        priorityClass: !exists(json, "priorityClass")
            ? undefined
            : json["priorityClass"],
        scheduleTimeoutSeconds: !exists(json, "scheduleTimeoutSeconds")
            ? undefined
            : json["scheduleTimeoutSeconds"],
    };
}

export function V1SchedulingPolicyToJSON(
    value?: V1SchedulingPolicy | null
): any {
    if (value === undefined) {
        return undefined;
    }
