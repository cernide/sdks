...
export function V1ValidationFromJSONTyped(
    json: any,
    ...
    return {
        ...
        containsKeys: !exists(json, "containsKeys")
            ? undefined
            : json["containsKeys"],
        excludesKeys: !exists(json, "excludesKeys")
            ? undefined
            : json["excludesKeys"],
    };
}
