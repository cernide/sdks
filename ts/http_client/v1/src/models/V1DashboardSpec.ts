...
export function V1DashboardSpecFromJSONTyped(
    json: any,
    ...
    return {
        sections: !exists(json, "sections")
            ? undefined
            : (json["sections"] as Array<any>).map(V1SectionSpecFromJSON),
        xaxis: !exists(json, "xaxis") ? undefined : json["xaxis"],
        smoothing: !exists(json, "smoothing") ? undefined : json["smoothing"],
        ignore_outliers: !exists(json, "ignore_outliers")
            ? undefined
            : json["ignore_outliers"],
        sample_size: !exists(json, "sample_size")
            ? undefined
            : json["sample_size"],
    };
}
    ...
    return {
        sections:
            value.sections === undefined
                ? undefined
                : (value.sections as Array<any>).map(V1SectionSpecToJSON),
        xaxis: value.xaxis,
