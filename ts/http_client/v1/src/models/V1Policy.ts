...
export function V1PolicyFromJSONTyped(
    json: any,
    ...
    return {
        ...
        excluded_features: !exists(json, "excluded_features")
            ? undefined
            : json["excluded_features"],
        excluded_runtimes: !exists(json, "excluded_runtimes")
            ? undefined
            : json["excluded_runtimes"],
        archived_deletion_interval: !exists(json, "archived_deletion_interval")
            ? undefined
            : json["archived_deletion_interval"],
        ...
        namespaces: !exists(json, "namespaces")
            ? undefined
            : json["namespaces"],
        user_accesses: !exists(json, "user_accesses")
            ? undefined
            : (json["user_accesses"] as Array<any>).map(V1UserAccessFromJSON),
        teams: !exists(json, "teams") ? undefined : json["teams"],
        projects: !exists(json, "projects") ? undefined : json["projects"],
        connected_projects: !exists(json, "connected_projects")
            ? undefined
            : json["connected_projects"],
    };
}
...
export function V1PolicyToJSON(value?: V1Policy | null): any {
    ...
    return {
        ...
        user_accesses:
            value.user_accesses === undefined
                ? undefined
                : (value.user_accesses as Array<any>).map(V1UserAccessToJSON),
        teams: value.teams,
