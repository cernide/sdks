...
export function V1EventSpanFromJSONTyped(
    json: any,
    ...
    return {
        ...
        children: !exists(json, "children")
            ? undefined
            : (json["children"] as Array<any>).map(V1EventSpanFromJSON),
        kind: !exists(json, "kind")
            ? undefined
            : V1EventSpanKindFromJSON(json["kind"]),
    };
}
    ...
    return {
        ...
        children:
            value.children === undefined
                ? undefined
                : (value.children as Array<any>).map(V1EventSpanToJSON),
