...
export function V1MXJobFromJSONTyped(
    json: any,
    ...
    return {
        ...
        cleanPodPolicy: !exists(json, "cleanPodPolicy")
            ? undefined
            : V1CleanPodPolicyFromJSON(json["cleanPodPolicy"]),
        schedulingPolicy: !exists(json, "schedulingPolicy")
            ? undefined
            : V1SchedulingPolicyFromJSON(json["schedulingPolicy"]),
        mode: !exists(json, "mode")
            ? undefined
            : MXJobModeFromJSON(json["mode"]),
        scheduler: !exists(json, "scheduler")
            ? undefined
            : V1KFReplicaFromJSON(json["scheduler"]),
        server: !exists(json, "server")
            ? undefined
            : V1KFReplicaFromJSON(json["server"]),
        worker: !exists(json, "worker")
            ? undefined
            : V1KFReplicaFromJSON(json["worker"]),
        tuner_tracker: !exists(json, "tuner_tracker")
            ? undefined
            : V1KFReplicaFromJSON(json["tuner_tracker"]),
        tuner_server: !exists(json, "tuner_server")
            ? undefined
            : V1KFReplicaFromJSON(json["tuner_server"]),
        tuner: !exists(json, "tuner")
            ? undefined
            : V1KFReplicaFromJSON(json["tuner"]),
    };
}
