...
import { V1RunFromJSON, V1RunFromJSONTyped, V1RunToJSON } from "./V1Run";
...
export function V1RunEdgeFromJSONTyped(
    json: any,
    ...
    return {
        upstream: !exists(json, "upstream")
            ? undefined
            : V1RunFromJSON(json["upstream"]),
        downstream: !exists(json, "downstream")
            ? undefined
            : V1RunFromJSON(json["downstream"]),
        kind: !exists(json, "kind")
            ? undefined
            : V1RunEdgeKindFromJSON(json["kind"]),
        values: !exists(json, "values") ? undefined : json["values"],
        statuses: !exists(json, "statuses")
            ? undefined
            : (json["statuses"] as Array<any>).map(V1StatusesFromJSON),
    };
}
    ...
    return {
        ...
        statuses:
            value.statuses === undefined
                ? undefined
                : (value.statuses as Array<any>).map(V1StatusesToJSON),
    };
}
