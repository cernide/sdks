...
export function V1IOFromJSONTyped(
    json: any,
    ...
    return {
        ...
        isOptional: !exists(json, "isOptional")
            ? undefined
            : json["isOptional"],
        ...
        validation: !exists(json, "validation")
            ? undefined
            : V1ValidationFromJSON(json["validation"]),
        delayValidation: !exists(json, "delayValidation")
            ? undefined
            : json["delayValidation"],
