...
export function V1BayesFromJSONTyped(
    json: any,
    ...
    return {
        ...
        numInitialRuns: !exists(json, "numInitialRuns")
            ? undefined
            : json["numInitialRuns"],
        maxIterations: !exists(json, "maxIterations")
            ? undefined
            : json["maxIterations"],
        utilityFunction: !exists(json, "utilityFunction")
            ? undefined
            : json["utilityFunction"],
        metric: !exists(json, "metric")
            ? undefined
            : V1OptimizationMetricFromJSON(json["metric"]),
        seed: !exists(json, "seed") ? undefined : json["seed"],
        concurrency: !exists(json, "concurrency")
            ? undefined
            : json["concurrency"],
        tuner: !exists(json, "tuner")
            ? undefined
            : V1TunerFromJSON(json["tuner"]),
