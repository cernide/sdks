...
export function V1EntityStageBodyRequestFromJSON(
    json: any
): V1EntityStageBodyRequest {
    return V1EntityStageBodyRequestFromJSONTyped(json, false);
}

export function V1EntityStageBodyRequestFromJSONTyped(
    json: any,
    ...
    return {
        ...
        condition: !exists(json, "condition")
            ? undefined
            : V1StageConditionFromJSON(json["condition"]),
    };
}

export function V1EntityStageBodyRequestToJSON(
    value?: V1EntityStageBodyRequest | null
): any {
    if (value === undefined) {
        return undefined;
    }
