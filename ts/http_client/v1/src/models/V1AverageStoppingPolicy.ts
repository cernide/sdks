...
export function V1AverageStoppingPolicyFromJSON(
    json: any
): V1AverageStoppingPolicy {
    return V1AverageStoppingPolicyFromJSONTyped(json, false);
}

export function V1AverageStoppingPolicyFromJSONTyped(
    json: any,
...
export function V1AverageStoppingPolicyToJSON(
    value?: V1AverageStoppingPolicy | null
): any {
    if (value === undefined) {
        return undefined;
    }
