...
export function V1EntityNotificationBodyFromJSON(
    json: any
): V1EntityNotificationBody {
    return V1EntityNotificationBodyFromJSONTyped(json, false);
}

export function V1EntityNotificationBodyFromJSONTyped(
    json: any,
...
export function V1EntityNotificationBodyToJSON(
    value?: V1EntityNotificationBody | null
): any {
    if (value === undefined) {
        return undefined;
    }
