...
export function V1ListBookmarksResponseFromJSON(
    json: any
): V1ListBookmarksResponse {
    return V1ListBookmarksResponseFromJSONTyped(json, false);
}

export function V1ListBookmarksResponseFromJSONTyped(
    json: any,
...
export function V1ListBookmarksResponseToJSON(
    value?: V1ListBookmarksResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
