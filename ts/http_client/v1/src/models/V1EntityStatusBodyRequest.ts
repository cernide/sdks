...
export function V1EntityStatusBodyRequestFromJSON(
    json: any
): V1EntityStatusBodyRequest {
    return V1EntityStatusBodyRequestFromJSONTyped(json, false);
}

export function V1EntityStatusBodyRequestFromJSONTyped(
    json: any,
    ...
    return {
        ...
        condition: !exists(json, "condition")
            ? undefined
            : V1StatusConditionFromJSON(json["condition"]),
        force: !exists(json, "force") ? undefined : json["force"],
    };
}

export function V1EntityStatusBodyRequestToJSON(
    value?: V1EntityStatusBodyRequest | null
): any {
    if (value === undefined) {
        return undefined;
    }
