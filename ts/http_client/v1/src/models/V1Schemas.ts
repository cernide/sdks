...
export function V1SchemasFromJSONTyped(
    json: any,
    ...
    return {
        earlyStopping: !exists(json, "earlyStopping")
            ? undefined
            : V1EarlyStoppingFromJSON(json["earlyStopping"]),
        matrix: !exists(json, "matrix")
            ? undefined
            : V1MatrixFromJSON(json["matrix"]),
        run: !exists(json, "run")
            ? undefined
            : V1RunSchemaFromJSON(json["run"]),
        operation: !exists(json, "operation")
            ? undefined
            : V1OperationFromJSON(json["operation"]),
        compiledOperation: !exists(json, "compiledOperation")
            ? undefined
            : V1CompiledOperationFromJSON(json["compiledOperation"]),
        schedule: !exists(json, "schedule")
            ? undefined
            : V1ScheduleFromJSON(json["schedule"]),
        connectionSchema: !exists(json, "connectionSchema")
            ? undefined
            : V1ConnectionSchemaFromJSON(json["connectionSchema"]),
        hpParams: !exists(json, "hpParams")
            ? undefined
            : V1HpParamsFromJSON(json["hpParams"]),
        reference: !exists(json, "reference")
            ? undefined
            : V1ReferenceFromJSON(json["reference"]),
        artifactsMount: !exists(json, "artifactsMount")
            ? undefined
            : V1ArtifactsMountFromJSON(json["artifactsMount"]),
        polyaxonSidecarContainer: !exists(json, "polyaxonSidecarContainer")
            ? undefined
            : V1PolyaxonSidecarContainerFromJSON(
                  json["polyaxonSidecarContainer"]
              ),
        polyaxonInitContainer: !exists(json, "polyaxonInitContainer")
            ? undefined
            : V1PolyaxonInitContainerFromJSON(json["polyaxonInitContainer"]),
        artifacs: !exists(json, "artifacs")
            ? undefined
            : V1ArtifactsTypeFromJSON(json["artifacs"]),
        wasb: !exists(json, "wasb")
            ? undefined
            : V1WasbTypeFromJSON(json["wasb"]),
        gcs: !exists(json, "gcs") ? undefined : V1GcsTypeFromJSON(json["gcs"]),
        s3: !exists(json, "s3") ? undefined : V1S3TypeFromJSON(json["s3"]),
        auth: !exists(json, "auth")
            ? undefined
            : V1AuthTypeFromJSON(json["auth"]),
        uri: !exists(json, "uri") ? undefined : V1UriTypeFromJSON(json["uri"]),
        resource: !exists(json, "resource")
            ? undefined
            : V1ConnectionResourceFromJSON(json["resource"]),
        connection: !exists(json, "connection")
            ? undefined
            : V1ConnectionTypeFromJSON(json["connection"]),
        eventType: !exists(json, "eventType")
            ? undefined
            : V1EventTypeFromJSON(json["eventType"]),
        matrixKind: !exists(json, "matrixKind")
            ? undefined
            : V1MatrixKindFromJSON(json["matrixKind"]),
        scheduleKind: !exists(json, "scheduleKind")
            ? undefined
            : V1ScheduleKindFromJSON(json["scheduleKind"]),
        event: !exists(json, "event")
            ? undefined
            : V1EventFromJSON(json["event"]),
    };
}
...
export function V1SchemasToJSON(value?: V1Schemas | null): any {
    ...
    return {
        ...
        polyaxonSidecarContainer: V1PolyaxonSidecarContainerToJSON(
            value.polyaxonSidecarContainer
        ),
        polyaxonInitContainer: V1PolyaxonInitContainerToJSON(
            value.polyaxonInitContainer
        ),
