...
export function V1AgentStateResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        state: !exists(json, "state")
            ? undefined
            : AgentStateResponseAgentStateFromJSON(json["state"]),
        live_state: !exists(json, "live_state")
            ? undefined
            : json["live_state"],
        compatible_updates: !exists(json, "compatible_updates")
            ? undefined
            : json["compatible_updates"],
    };
}

export function V1AgentStateResponseToJSON(
    value?: V1AgentStateResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
