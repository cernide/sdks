...
export function V1ListSearchesResponseFromJSON(
    json: any
): V1ListSearchesResponse {
    return V1ListSearchesResponseFromJSONTyped(json, false);
}

export function V1ListSearchesResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1SearchFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListSearchesResponseToJSON(
    value?: V1ListSearchesResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1SearchToJSON),
