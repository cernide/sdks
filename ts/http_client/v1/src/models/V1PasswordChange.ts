...
export function V1PasswordChangeFromJSONTyped(
    json: any,
    ...
    return {
        old_password: !exists(json, "old_password")
            ? undefined
            : json["old_password"],
        new_password1: !exists(json, "new_password1")
            ? undefined
            : json["new_password1"],
        new_password2: !exists(json, "new_password2")
            ? undefined
            : json["new_password2"],
    };
}
