...
export function V1EarlyStoppingFromJSONTyped(
    json: any,
    ...
    return {
        median: !exists(json, "median")
            ? undefined
            : V1MedianStoppingPolicyFromJSON(json["median"]),
        diff: !exists(json, "diff")
            ? undefined
            : V1DiffStoppingPolicyFromJSON(json["diff"]),
        truncation: !exists(json, "truncation")
            ? undefined
            : V1TruncationStoppingPolicyFromJSON(json["truncation"]),
        metric: !exists(json, "metric")
            ? undefined
            : V1MetricEarlyStoppingFromJSON(json["metric"]),
        failure: !exists(json, "failure")
            ? undefined
            : V1FailureEarlyStoppingFromJSON(json["failure"]),
    };
}
