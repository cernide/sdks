...
export function V1MultiEventsResponseFromJSON(
    json: any
): V1MultiEventsResponse {
    return V1MultiEventsResponseFromJSONTyped(json, false);
}

export function V1MultiEventsResponseFromJSONTyped(
    json: any,
...
export function V1MultiEventsResponseToJSON(
    value?: V1MultiEventsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
