...
export function V1EventFromJSONTyped(
    json: any,
    ...
    return {
        ...
        image: !exists(json, "image")
            ? undefined
            : V1EventImageFromJSON(json["image"]),
        histogram: !exists(json, "histogram")
            ? undefined
            : V1EventHistogramFromJSON(json["histogram"]),
        audio: !exists(json, "audio")
            ? undefined
            : V1EventAudioFromJSON(json["audio"]),
        video: !exists(json, "video")
            ? undefined
            : V1EventVideoFromJSON(json["video"]),
        html: !exists(json, "html") ? undefined : json["html"],
        text: !exists(json, "text") ? undefined : json["text"],
        chart: !exists(json, "chart")
            ? undefined
            : V1EventChartFromJSON(json["chart"]),
        model: !exists(json, "model")
            ? undefined
            : V1EventModelFromJSON(json["model"]),
        artifact: !exists(json, "artifact")
            ? undefined
            : V1EventArtifactFromJSON(json["artifact"]),
        dataframe: !exists(json, "dataframe")
            ? undefined
            : V1EventDataframeFromJSON(json["dataframe"]),
        curve: !exists(json, "curve")
            ? undefined
            : V1EventCurveFromJSON(json["curve"]),
        confusion: !exists(json, "confusion")
            ? undefined
            : V1EventConfusionMatrixFromJSON(json["confusion"]),
        span: !exists(json, "span")
            ? undefined
            : V1EventSpanFromJSON(json["span"]),
    };
}
