...
export function V1ConnectionResourceFromJSONTyped(
    json: any,
    ...
    return {
        ...
        defaultMode: !exists(json, "defaultMode")
            ? undefined
            : json["defaultMode"],
    };
}

export function V1ConnectionResourceToJSON(
    value?: V1ConnectionResource | null
): any {
    if (value === undefined) {
        return undefined;
    }
