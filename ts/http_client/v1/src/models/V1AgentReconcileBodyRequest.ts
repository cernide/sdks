...
export function V1AgentReconcileBodyRequestFromJSON(
    json: any
): V1AgentReconcileBodyRequest {
    return V1AgentReconcileBodyRequestFromJSONTyped(json, false);
}

export function V1AgentReconcileBodyRequestFromJSONTyped(
    json: any,
...
export function V1AgentReconcileBodyRequestToJSON(
    value?: V1AgentReconcileBodyRequest | null
): any {
    if (value === undefined) {
        return undefined;
    }
