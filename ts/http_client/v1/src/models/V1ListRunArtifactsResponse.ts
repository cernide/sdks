...
export function V1ListRunArtifactsResponseFromJSON(
    json: any
): V1ListRunArtifactsResponse {
    return V1ListRunArtifactsResponseFromJSONTyped(json, false);
}

export function V1ListRunArtifactsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1RunArtifactFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListRunArtifactsResponseToJSON(
    value?: V1ListRunArtifactsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1RunArtifactToJSON),
