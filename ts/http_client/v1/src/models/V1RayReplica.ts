...
import { V1InitFromJSON, V1InitFromJSONTyped, V1InitToJSON } from "./V1Init";
...
export function V1RayReplicaFromJSONTyped(
    json: any,
    ...
    return {
        ...
        rayStartParams: !exists(json, "rayStartParams")
            ? undefined
            : json["rayStartParams"],
        environment: !exists(json, "environment")
            ? undefined
            : V1EnvironmentFromJSON(json["environment"]),
        connections: !exists(json, "connections")
            ? undefined
            : json["connections"],
        volumes: !exists(json, "volumes") ? undefined : json["volumes"],
        init: !exists(json, "init")
            ? undefined
            : (json["init"] as Array<any>).map(V1InitFromJSON),
    ...
    return {
        ...
        init:
            value.init === undefined
                ? undefined
                : (value.init as Array<any>).map(V1InitToJSON),
