...
export function V1TeamFromJSONTyped(
    json: any,
    ...
    return {
        ...
        component_hubs: !exists(json, "component_hubs")
            ? undefined
            : json["component_hubs"],
        model_registries: !exists(json, "model_registries")
            ? undefined
            : json["model_registries"],
        settings: !exists(json, "settings")
            ? undefined
            : V1TeamSettingsFromJSON(json["settings"]),
