...
export function V1ListRunConnectionsResponseFromJSON(
    json: any
): V1ListRunConnectionsResponse {
    return V1ListRunConnectionsResponseFromJSONTyped(json, false);
}

export function V1ListRunConnectionsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1RunConnectionFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListRunConnectionsResponseToJSON(
    value?: V1ListRunConnectionsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1RunConnectionToJSON),
