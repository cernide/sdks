...
import { V1DagFromJSON, V1DagFromJSONTyped, V1DagToJSON } from "./V1Dag";
...
import { V1JobFromJSON, V1JobFromJSONTyped, V1JobToJSON } from "./V1Job";
...
export function V1RunSchemaFromJSONTyped(
    json: any,
    ...
    return {
        ...
        service: !exists(json, "service")
            ? undefined
            : V1ServiceFromJSON(json["service"]),
        dag: !exists(json, "dag") ? undefined : V1DagFromJSON(json["dag"]),
        tfJob: !exists(json, "tfJob")
            ? undefined
            : V1TFJobFromJSON(json["tfJob"]),
        pytorchJob: !exists(json, "pytorchJob")
            ? undefined
            : V1PytorchJobFromJSON(json["pytorchJob"]),
        mpiJob: !exists(json, "mpiJob")
            ? undefined
            : V1MPIJobFromJSON(json["mpiJob"]),
        mxJob: !exists(json, "mxJob")
            ? undefined
            : V1MXJobFromJSON(json["mxJob"]),
        xgboostJob: !exists(json, "xgboostJob")
            ? undefined
            : V1XGBoostJobFromJSON(json["xgboostJob"]),
        paddleJob: !exists(json, "paddleJob")
            ? undefined
            : V1PaddleJobFromJSON(json["paddleJob"]),
        daskJob: !exists(json, "daskJob")
            ? undefined
            : V1DaskJobFromJSON(json["daskJob"]),
        rayJob: !exists(json, "rayJob")
            ? undefined
            : V1RayJobFromJSON(json["rayJob"]),
    };
}
