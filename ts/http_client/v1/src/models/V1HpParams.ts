...
export function V1HpParamsFromJSONTyped(
    json: any,
    ...
    return {
        choice: !exists(json, "choice")
            ? undefined
            : V1HpChoiceFromJSON(json["choice"]),
        pchoice: !exists(json, "pchoice")
            ? undefined
            : V1HpPChoiceFromJSON(json["pchoice"]),
        range: !exists(json, "range")
            ? undefined
            : V1HpRangeFromJSON(json["range"]),
        linspace: !exists(json, "linspace")
            ? undefined
            : V1HpLinSpaceFromJSON(json["linspace"]),
        logspace: !exists(json, "logspace")
            ? undefined
            : V1HpLogSpaceFromJSON(json["logspace"]),
        geomspace: !exists(json, "geomspace")
            ? undefined
            : V1HpGeomSpaceFromJSON(json["geomspace"]),
        uniform: !exists(json, "uniform")
            ? undefined
            : V1HpUniformFromJSON(json["uniform"]),
        quniform: !exists(json, "quniform")
            ? undefined
            : V1HpQUniformFromJSON(json["quniform"]),
        loguniform: !exists(json, "loguniform")
            ? undefined
            : V1HpLogUniformFromJSON(json["loguniform"]),
        qloguniform: !exists(json, "qloguniform")
            ? undefined
            : V1HpQLogUniformFromJSON(json["qloguniform"]),
        normal: !exists(json, "normal")
            ? undefined
            : V1HpNormalFromJSON(json["normal"]),
        qnormal: !exists(json, "qnormal")
            ? undefined
            : V1HpQNormalFromJSON(json["qnormal"]),
        lognormal: !exists(json, "lognormal")
            ? undefined
            : V1HpLogNormalFromJSON(json["lognormal"]),
        qlognormal: !exists(json, "qlognormal")
            ? undefined
            : V1HpQLogNormalFromJSON(json["qlognormal"]),
        daterange: !exists(json, "daterange")
            ? undefined
            : V1HpDateRangeFromJSON(json["daterange"]),
        datetimerange: !exists(json, "datetimerange")
            ? undefined
            : V1HpDateTimeRangeFromJSON(json["datetimerange"]),
    };
}
