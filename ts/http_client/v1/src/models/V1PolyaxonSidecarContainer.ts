...
export function V1PolyaxonSidecarContainerFromJSON(
    json: any
): V1PolyaxonSidecarContainer {
    return V1PolyaxonSidecarContainerFromJSONTyped(json, false);
}

export function V1PolyaxonSidecarContainerFromJSONTyped(
    json: any,
    ...
    return {
        ...
        imagePullPolicy: !exists(json, "imagePullPolicy")
            ? undefined
            : json["imagePullPolicy"],
        sleepInterval: !exists(json, "sleepInterval")
            ? undefined
            : json["sleepInterval"],
        syncInterval: !exists(json, "syncInterval")
            ? undefined
            : json["syncInterval"],
        monitorLogs: !exists(json, "monitorLogs")
            ? undefined
            : json["monitorLogs"],
        monitorSpec: !exists(json, "monitorSpec")
            ? undefined
            : json["monitorSpec"],
...
export function V1PolyaxonSidecarContainerToJSON(
    value?: V1PolyaxonSidecarContainer | null
): any {
    if (value === undefined) {
        return undefined;
    }
