...
export function V1OrganizationFromJSONTyped(
    json: any,
    ...
    return {
        ...
        user_email: !exists(json, "user_email")
            ? undefined
            : json["user_email"],
        ...
        support_revoke_at: !exists(json, "support_revoke_at")
            ? undefined
            : new Date(json["support_revoke_at"]),
        ...
        is_cloud_viewable: !exists(json, "is_cloud_viewable")
            ? undefined
            : json["is_cloud_viewable"],
...
export function V1OrganizationToJSON(value?: V1Organization | null): any {
    ...
    return {
        ...
        support_revoke_at:
            value.support_revoke_at === undefined
                ? undefined
                : value.support_revoke_at.toISOString(),
