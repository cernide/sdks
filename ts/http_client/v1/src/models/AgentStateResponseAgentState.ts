...
export function AgentStateResponseAgentStateFromJSON(
    json: any
): AgentStateResponseAgentState {
    return AgentStateResponseAgentStateFromJSONTyped(json, false);
}

export function AgentStateResponseAgentStateFromJSONTyped(
    json: any,
...
export function AgentStateResponseAgentStateToJSON(
    value?: AgentStateResponseAgentState | null
): any {
    if (value === undefined) {
        return undefined;
    }
