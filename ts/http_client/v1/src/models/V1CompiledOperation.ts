...
import { V1HookFromJSON, V1HookFromJSONTyped, V1HookToJSON } from "./V1Hook";
import type { V1IO } from "./V1IO";
import { V1IOFromJSON, V1IOFromJSONTyped, V1IOToJSON } from "./V1IO";
import type { V1Join } from "./V1Join";
import { V1JoinFromJSON, V1JoinFromJSONTyped, V1JoinToJSON } from "./V1Join";
...
export function V1CompiledOperationFromJSONTyped(
    json: any,
    ...
    return {
        ...
        cache: !exists(json, "cache")
            ? undefined
            : V1CacheFromJSON(json["cache"]),
        namespace: !exists(json, "namespace") ? undefined : json["namespace"],
        termination: !exists(json, "termination")
            ? undefined
            : V1TerminationFromJSON(json["termination"]),
        plugins: !exists(json, "plugins")
            ? undefined
            : V1PluginsFromJSON(json["plugins"]),
        schedule: !exists(json, "schedule") ? undefined : json["schedule"],
        events: !exists(json, "events")
            ? undefined
            : (json["events"] as Array<any>).map(V1EventTriggerFromJSON),
        build: !exists(json, "build")
            ? undefined
            : V1BuildFromJSON(json["build"]),
        hooks: !exists(json, "hooks")
            ? undefined
            : (json["hooks"] as Array<any>).map(V1HookFromJSON),
        dependencies: !exists(json, "dependencies")
            ? undefined
            : json["dependencies"],
        trigger: !exists(json, "trigger")
            ? undefined
            : V1TriggerPolicyFromJSON(json["trigger"]),
        conditions: !exists(json, "conditions")
            ? undefined
            : json["conditions"],
        skipOnUpstreamSkip: !exists(json, "skipOnUpstreamSkip")
            ? undefined
            : json["skipOnUpstreamSkip"],
        matrix: !exists(json, "matrix") ? undefined : json["matrix"],
        joins: !exists(json, "joins")
            ? undefined
            : mapValues(json["joins"], V1JoinFromJSON),
        inputs: !exists(json, "inputs")
            ? undefined
            : (json["inputs"] as Array<any>).map(V1IOFromJSON),
        outputs: !exists(json, "outputs")
            ? undefined
            : (json["outputs"] as Array<any>).map(V1IOFromJSON),
        contexts: !exists(json, "contexts")
            ? undefined
            : (json["contexts"] as Array<any>).map(V1IOFromJSON),
        isApproved: !exists(json, "isApproved")
            ? undefined
            : json["isApproved"],
...
export function V1CompiledOperationToJSON(
    value?: V1CompiledOperation | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        events:
            value.events === undefined
                ? undefined
                : (value.events as Array<any>).map(V1EventTriggerToJSON),
        build: V1BuildToJSON(value.build),
        hooks:
            value.hooks === undefined
                ? undefined
                : (value.hooks as Array<any>).map(V1HookToJSON),
        ...
        joins:
            value.joins === undefined
                ? undefined
                : mapValues(value.joins, V1JoinToJSON),
        inputs:
            value.inputs === undefined
                ? undefined
                : (value.inputs as Array<any>).map(V1IOToJSON),
        outputs:
            value.outputs === undefined
                ? undefined
                : (value.outputs as Array<any>).map(V1IOToJSON),
        contexts:
            value.contexts === undefined
                ? undefined
                : (value.contexts as Array<any>).map(V1IOToJSON),
