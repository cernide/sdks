...
export function V1TFJobFromJSONTyped(
    json: any,
    ...
    return {
        ...
        successPolicy: !exists(json, "successPolicy")
            ? undefined
            : json["successPolicy"],
        enableDynamicWorker: !exists(json, "enableDynamicWorker")
            ? undefined
            : json["enableDynamicWorker"],
        chief: !exists(json, "chief")
            ? undefined
            : V1KFReplicaFromJSON(json["chief"]),
        worker: !exists(json, "worker")
            ? undefined
            : V1KFReplicaFromJSON(json["worker"]),
        ps: !exists(json, "ps") ? undefined : V1KFReplicaFromJSON(json["ps"]),
        evaluator: !exists(json, "evaluator")
            ? undefined
            : V1KFReplicaFromJSON(json["evaluator"]),
    };
}
