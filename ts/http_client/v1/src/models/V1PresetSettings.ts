...
export function V1PresetSettingsFromJSONTyped(
    json: any,
    ...
    return {
        ...
        runs: !exists(json, "runs")
            ? undefined
            : (json["runs"] as Array<any>).map(V1SettingsCatalogFromJSON),
    };
}
    ...
    return {
        ...
        runs:
            value.runs === undefined
                ? undefined
                : (value.runs as Array<any>).map(V1SettingsCatalogToJSON),
    };
}
