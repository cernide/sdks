...
export function V1EventAudioFromJSONTyped(
    json: any,
    ...
    return {
        sample_rate: !exists(json, "sample_rate")
            ? undefined
            : json["sample_rate"],
        num_channels: !exists(json, "num_channels")
            ? undefined
            : json["num_channels"],
        length_frames: !exists(json, "length_frames")
            ? undefined
            : json["length_frames"],
        content_type: !exists(json, "content_type")
            ? undefined
            : json["content_type"],
