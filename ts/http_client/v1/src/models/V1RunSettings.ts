...
export function V1RunSettingsFromJSONTyped(
    json: any,
    ...
    return {
        ...
        agent: !exists(json, "agent")
            ? undefined
            : V1SettingsCatalogFromJSON(json["agent"]),
        queue: !exists(json, "queue")
            ? undefined
            : V1SettingsCatalogFromJSON(json["queue"]),
        artifacts_store: !exists(json, "artifacts_store")
            ? undefined
            : V1SettingsCatalogFromJSON(json["artifacts_store"]),
        tensorboard: !exists(json, "tensorboard")
            ? undefined
            : json["tensorboard"],
        ...
        models: !exists(json, "models")
            ? undefined
            : (json["models"] as Array<any>).map(V1RunReferenceCatalogFromJSON),
        artifacts: !exists(json, "artifacts")
            ? undefined
            : (json["artifacts"] as Array<any>).map(
                  V1RunReferenceCatalogFromJSON
              ),
    };
}
    ...
    return {
        ...
        models:
            value.models === undefined
                ? undefined
                : (value.models as Array<any>).map(V1RunReferenceCatalogToJSON),
        artifacts:
            value.artifacts === undefined
                ? undefined
                : (value.artifacts as Array<any>).map(
                      V1RunReferenceCatalogToJSON
                  ),
    };
}
