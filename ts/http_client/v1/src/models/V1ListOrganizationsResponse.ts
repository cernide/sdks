...
export function V1ListOrganizationsResponseFromJSON(
    json: any
): V1ListOrganizationsResponse {
    return V1ListOrganizationsResponseFromJSONTyped(json, false);
}

export function V1ListOrganizationsResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1OrganizationFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListOrganizationsResponseToJSON(
    value?: V1ListOrganizationsResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1OrganizationToJSON),
