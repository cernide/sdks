...
export function V1ListActivitiesResponseFromJSON(
    json: any
): V1ListActivitiesResponse {
    return V1ListActivitiesResponseFromJSONTyped(json, false);
}

export function V1ListActivitiesResponseFromJSONTyped(
    json: any,
    ...
    return {
        ...
        results: !exists(json, "results")
            ? undefined
            : (json["results"] as Array<any>).map(V1ActivityFromJSON),
        previous: !exists(json, "previous") ? undefined : json["previous"],
        next: !exists(json, "next") ? undefined : json["next"],
    };
}

export function V1ListActivitiesResponseToJSON(
    value?: V1ListActivitiesResponse | null
): any {
    if (value === undefined) {
        return undefined;
    }
    ...
    return {
        ...
        results:
            value.results === undefined
                ? undefined
                : (value.results as Array<any>).map(V1ActivityToJSON),
