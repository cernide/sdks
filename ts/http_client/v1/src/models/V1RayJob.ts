...
export function V1RayJobFromJSONTyped(
    json: any,
    ...
    return {
        ...
        entrypoint: !exists(json, "entrypoint")
            ? undefined
            : json["entrypoint"],
        runtimeEnv: !exists(json, "runtimeEnv")
            ? undefined
            : json["runtimeEnv"],
        metadata: !exists(json, "metadata") ? undefined : json["metadata"],
        rayVersion: !exists(json, "rayVersion")
            ? undefined
            : json["rayVersion"],
        head: !exists(json, "head")
            ? undefined
            : V1RayReplicaFromJSON(json["head"]),
        workers: !exists(json, "workers")
            ? undefined
            : (json["workers"] as Array<any>).map(V1RayReplicaFromJSON),
    };
}
    ...
    return {
        ...
        workers:
            value.workers === undefined
                ? undefined
                : (value.workers as Array<any>).map(V1RayReplicaToJSON),
    };
}
