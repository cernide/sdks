...
export function V1FailureEarlyStoppingFromJSON(
    json: any
): V1FailureEarlyStopping {
    return V1FailureEarlyStoppingFromJSONTyped(json, false);
}

export function V1FailureEarlyStoppingFromJSONTyped(
    json: any,
...
export function V1FailureEarlyStoppingToJSON(
    value?: V1FailureEarlyStopping | null
): any {
    if (value === undefined) {
        return undefined;
    }
