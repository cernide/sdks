...
export function V1AgentStatusBodyRequestFromJSON(
    json: any
): V1AgentStatusBodyRequest {
    return V1AgentStatusBodyRequestFromJSONTyped(json, false);
}

export function V1AgentStatusBodyRequestFromJSONTyped(
    json: any,
...
export function V1AgentStatusBodyRequestToJSON(
    value?: V1AgentStatusBodyRequest | null
): any {
    if (value === undefined) {
        return undefined;
    }
