...
export function V1DagFromJSONTyped(
    json: any,
    ...
    return {
        ...
        operations: !exists(json, "operations")
            ? undefined
            : (json["operations"] as Array<any>).map(V1OperationFromJSON),
        components: !exists(json, "components")
            ? undefined
            : (json["components"] as Array<any>).map(V1ComponentFromJSON),
    ...
    return {
        ...
        operations:
            value.operations === undefined
                ? undefined
                : (value.operations as Array<any>).map(V1OperationToJSON),
        components:
            value.components === undefined
                ? undefined
                : (value.components as Array<any>).map(V1ComponentToJSON),
