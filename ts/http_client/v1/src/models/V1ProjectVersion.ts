...
export function V1ProjectVersionFromJSONTyped(
    json: any,
    ...
    return {
        ...
        stage: !exists(json, "stage")
            ? undefined
            : V1StagesFromJSON(json["stage"]),
        kind: !exists(json, "kind")
            ? undefined
            : V1ProjectVersionKindFromJSON(json["kind"]),
        stage_conditions: !exists(json, "stage_conditions")
            ? undefined
            : (json["stage_conditions"] as Array<any>).map(
                  V1StageConditionFromJSON
              ),
...
export function V1ProjectVersionToJSON(value?: V1ProjectVersion | null): any {
    ...
    return {
        ...
        stage_conditions:
            value.stage_conditions === undefined
                ? undefined
                : (value.stage_conditions as Array<any>).map(
                      V1StageConditionToJSON
                  ),
