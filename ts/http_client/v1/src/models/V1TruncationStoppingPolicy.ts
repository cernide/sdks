...
export function V1TruncationStoppingPolicyFromJSON(
    json: any
): V1TruncationStoppingPolicy {
    return V1TruncationStoppingPolicyFromJSONTyped(json, false);
}

export function V1TruncationStoppingPolicyFromJSONTyped(
    json: any,
    ...
    return {
        ...
        evaluationInterval: !exists(json, "evaluationInterval")
            ? undefined
            : json["evaluationInterval"],
        minInterval: !exists(json, "minInterval")
            ? undefined
            : json["minInterval"],
        minSamples: !exists(json, "minSamples")
            ? undefined
            : json["minSamples"],
        includeSucceeded: !exists(json, "includeSucceeded")
            ? undefined
            : json["includeSucceeded"],
    };
}

export function V1TruncationStoppingPolicyToJSON(
    value?: V1TruncationStoppingPolicy | null
): any {
    if (value === undefined) {
        return undefined;
    }
