...
export function V1OptimizationResourceFromJSON(
    json: any
): V1OptimizationResource {
    return V1OptimizationResourceFromJSONTyped(json, false);
}

export function V1OptimizationResourceFromJSONTyped(
    json: any,
    ...
    return {
        ...
        type: !exists(json, "type")
            ? undefined
            : V1ResourceTypeFromJSON(json["type"]),
    };
}

export function V1OptimizationResourceToJSON(
    value?: V1OptimizationResource | null
): any {
    if (value === undefined) {
        return undefined;
    }
