...
export function V1ActivityFromJSONTyped(
    json: any,
    ...
    return {
        ...
        event_action: !exists(json, "event_action")
            ? undefined
            : json["event_action"],
        event_subject: !exists(json, "event_subject")
            ? undefined
            : json["event_subject"],
        object_name: !exists(json, "object_name")
            ? undefined
            : json["object_name"],
        object_uuid: !exists(json, "object_uuid")
            ? undefined
            : json["object_uuid"],
        object_parent: !exists(json, "object_parent")
            ? undefined
            : json["object_parent"],
    };
}
