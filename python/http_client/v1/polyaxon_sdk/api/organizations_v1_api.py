...
class OrganizationsV1Api(object):
    ...
    def delete_organization_invitation_with_http_info(self, owner: Annotated[StrictStr, Field(..., description="Owner of the namespace")], member_user: Annotated[Optional[StrictStr], Field(description="User.")] = None, member_user_email: Annotated[Optional[StrictStr], Field(description="Read-only User email.")] = None, member_role: Annotated[Optional[StrictStr], Field(description="Role.")] = None, member_kind: Annotated[Optional[StrictStr], Field(description="Kind.")] = None, member_created_at: Annotated[Optional[datetime], Field(description="Optional time when the entity was created.")] = None, member_updated_at: Annotated[Optional[datetime], Field(description="Optional last time the entity was updated.")] = None, email: Annotated[Optional[StrictStr], Field(description="Optional email.")] = None, **kwargs):  # noqa: E501
        ...
        if _params.get('member_user_email') is not None:  # noqa: E501
            _query_params.append(
                ('member.user_email', _params['member_user_email']))
        ...
        if _params.get('member_created_at') is not None:  # noqa: E501
            if isinstance(_params['member_created_at'], datetime):
                _query_params.append(('member.created_at', _params['member_created_at'].strftime(
        ...
        if _params.get('member_updated_at') is not None:  # noqa: E501
            if isinstance(_params['member_updated_at'], datetime):
                _query_params.append(('member.updated_at', _params['member_updated_at'].strftime(
                    self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(
    ...
    def get_organization_settings_with_http_info(self, owner: Annotated[StrictStr, Field(..., description="Owner of the namespace")], organization_user: Annotated[Optional[StrictStr], Field(description="User.")] = None, organization_user_email: Annotated[Optional[StrictStr], Field(description="Read-only User email.")] = None, organization_name: Annotated[Optional[StrictStr], Field(description="Name.")] = None, organization_is_public: Annotated[Optional[StrictBool], Field(description="Optional flag to tell if this organization is public.")] = None, organization_created_at: Annotated[Optional[datetime], Field(description="Optional time when the entity was created.")] = None, organization_updated_at: Annotated[Optional[datetime], Field(description="Optional last time the entity was updated.")] = None, organization_support_revoke_at: Annotated[Optional[datetime], Field(description="Optional time to revoke support access.")] = None, organization_expiration: Annotated[Optional[StrictInt], Field(description="Optional expiration for support.")] = None, organization_role: Annotated[Optional[StrictStr], Field(description="Current user's role in this org.")] = None, organization_queue: Annotated[Optional[StrictStr], Field(description="Default queue.")] = None, organization_preset: Annotated[Optional[StrictStr], Field(description="Default preset.")] = None, organization_is_cloud_viewable: Annotated[Optional[StrictBool], Field(description="Setting to enable viewable metadata on cloud.")] = None, organization_archived_deletion_interval: Annotated[Optional[StrictInt], Field(description="Setting to configure default archived deletion interval.")] = None, **kwargs):  # noqa: E501
        ...
        if _params.get('organization_user') is not None:  # noqa: E501
            _query_params.append(
                ('organization.user', _params['organization_user']))
        ...
        if _params.get('organization_name') is not None:  # noqa: E501
            _query_params.append(
                ('organization.name', _params['organization_name']))
        ...
        if _params.get('organization_created_at') is not None:  # noqa: E501
            if isinstance(_params['organization_created_at'], datetime):
                _query_params.append(('organization.created_at', _params['organization_created_at'].strftime(
                    self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(
        ...
        if _params.get('organization_updated_at') is not None:  # noqa: E501
            if isinstance(_params['organization_updated_at'], datetime):
                _query_params.append(('organization.updated_at', _params['organization_updated_at'].strftime(
                    self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(
        ...
        if _params.get('organization_support_revoke_at') is not None:  # noqa: E501
            if isinstance(_params['organization_support_revoke_at'], datetime):
                _query_params.append(('organization.support_revoke_at', _params['organization_support_revoke_at'].strftime(
                    self.api_client.configuration.datetime_format)))
            else:
                _query_params.append(
                    ('organization.support_revoke_at', _params['organization_support_revoke_at']))
        ...
        if _params.get('organization_role') is not None:  # noqa: E501
            _query_params.append(
                ('organization.role', _params['organization_role']))

        if _params.get('organization_queue') is not None:  # noqa: E501
            _query_params.append(
                ('organization.queue', _params['organization_queue']))
        ...
        if _params.get('organization_is_cloud_viewable') is not None:  # noqa: E501
            _query_params.append(
                ('organization.is_cloud_viewable', _params['organization_is_cloud_viewable']))

        if _params.get('organization_archived_deletion_interval') is not None:  # noqa: E501
            _query_params.append(('organization.archived_deletion_interval',
