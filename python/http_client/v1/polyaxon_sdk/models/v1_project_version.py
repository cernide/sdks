...
class V1ProjectVersion(BaseModel):
    ...
    meta_info: Optional[Dict[str, Any]] = Field(
        None, description="Extra information related to the run, lineage, artifacts, ...")
    ...
    __properties = ["uuid", "name", "description", "tags", "owner", "project", "connection", "run", "artifacts", "meta_info",
                    "created_at", "updated_at", "stage", "kind", "stage_conditions", "content", "readme", "state", "role", "contributors"]
