...
class V1SchedulingPolicy(BaseModel):
    ...
    schedule_timeout_seconds: Optional[StrictInt] = Field(
        None, alias="scheduleTimeoutSeconds")
    __properties = ["minAvailable", "queue", "minResources",
                    "priorityClass", "scheduleTimeoutSeconds"]
