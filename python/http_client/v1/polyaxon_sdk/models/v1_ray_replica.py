...
class V1RayReplica(BaseModel):
    ...
    ray_start_params: Optional[Dict[str, StrictStr]
                               ] = Field(None, alias="rayStartParams")
    ...
    __properties = ["replicas", "minReplicas", "maxReplicas", "groupName", "rayStartParams",
                    "environment", "connections", "volumes", "init", "sidecars", "container"]
