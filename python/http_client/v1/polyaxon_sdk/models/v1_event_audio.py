...
class V1EventAudio(BaseModel):
    ...
    V1EventAudio
    """
    sample_rate: Optional[StrictFloat] = Field(
        None, description="Sample rate of the audio in Hz.")
    num_channels: Optional[StrictInt] = Field(
        None, description="Number of channels of audio.")
    length_frames: Optional[StrictInt] = Field(
        None, description="Length of the audio in frames (samples per channel).")
    content_type: Optional[StrictStr] = None
    path: Optional[StrictStr] = None
    __properties = ["sample_rate", "num_channels",
                    "length_frames", "content_type", "path"]
