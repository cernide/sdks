...
class V1Plugins(BaseModel):
    ...
    mount_artifacts_store: Optional[StrictBool] = Field(
        None, alias="mountArtifactsStore")
    collect_artifacts: Optional[StrictBool] = Field(
        None, alias="collectArtifacts")
    collect_logs: Optional[StrictBool] = Field(None, alias="collectLogs")
    collect_resources: Optional[StrictBool] = Field(
        None, alias="collectResources")
    ...
    __properties = ["auth", "docker", "shm", "mountArtifactsStore", "collectArtifacts", "collectLogs",
                    "collectResources", "syncStatuses", "autoResume", "logLevel", "externalHost", "sidecar", "notifications"]
