...
class V1PaddleJob(BaseModel):
    ...
    elastic_policy: Optional[V1PaddleElasticPolic] = Field(
        None, alias="elasticPolicy")
    master: Optional[V1KFReplica] = None
    worker: Optional[V1KFReplica] = None
    __properties = ["kind", "cleanPodPolicy",
                    "schedulingPolicy", "elasticPolicy", "master", "worker"]
