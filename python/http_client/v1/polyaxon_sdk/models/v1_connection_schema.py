...
class V1ConnectionSchema(BaseModel):
    ...
    V1ConnectionSchema
    """
    bucket_connection: Optional[V1BucketConnection] = Field(
        None, alias="bucketConnection")
    host_path_connection: Optional[V1HostPathConnection] = Field(
        None, alias="hostPathConnection")
    claim_connection: Optional[V1ClaimConnection] = Field(
        None, alias="claimConnection")
    host_connection: Optional[V1HostConnection] = Field(
        None, alias="hostConnection")
    git_connection: Optional[V1GitConnection] = Field(
        None, alias="gitConnection")
    __properties = ["bucketConnection", "hostPathConnection",
                    "claimConnection", "hostConnection", "gitConnection"]
