...
class V1Bayes(BaseModel):
    ...
    utility_function: Optional[Dict[str, Any]] = Field(
        None, alias="utilityFunction")
    ...
    __properties = ["kind", "params", "numInitialRuns", "maxIterations",
                    "utilityFunction", "metric", "seed", "concurrency", "tuner", "earlyStopping"]
