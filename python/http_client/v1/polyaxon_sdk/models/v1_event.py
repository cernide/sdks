...
class V1Event(BaseModel):
    ...
    step: Optional[StrictInt] = Field(
        None, description="Global step of the event.")
    ...
    __properties = ["timestamp", "step", "metric", "image", "histogram", "audio", "video",
                    "html", "text", "chart", "model", "artifact", "dataframe", "curve", "confusion", "span"]
