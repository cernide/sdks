...
class V1Hook(BaseModel):
    ...
    disable_defaults: Optional[StrictBool] = Field(
        None, alias="disableDefaults")
    __properties = ["hubRef", "connection", "trigger", "conditions",
                    "params", "presets", "queue", "namespace", "disableDefaults"]
