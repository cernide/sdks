...
class V1Environment(BaseModel):
    ...
    node_selector: Optional[Dict[str, StrictStr]
                            ] = Field(None, alias="nodeSelector")
    affinity: Optional[Dict[str, Any]] = None
    tolerations: Optional[conlist(Dict[str, Any])] = Field(
        None, description="Optional Tolerations to apply.")
    node_name: Optional[StrictStr] = Field(
        None, alias="nodeName", description="Optional NodeName is a request to schedule this pod onto a specific node. If it is non-empty, the scheduler simply schedules this pod onto that node, assuming that it fits resource requirements.")
    service_account_name: Optional[StrictStr] = Field(
        None, alias="serviceAccountName")
    host_aliases: Optional[conlist(Dict[str, Any])] = Field(
        None, alias="hostAliases", description="Optional HostAliases is an optional list of hosts and IPs that will be injected into the pod spec.")
    security_context: Optional[Dict[str, Any]] = Field(
        None, alias="securityContext")
    image_pull_secrets: Optional[conlist(StrictStr)] = Field(
    ...
    host_pid: Optional[StrictStr] = Field(
        None, alias="hostPID", description="Use the host's pid namespace. Default to false.")
    ...
    priority_class_name: Optional[StrictStr] = Field(
        None, alias="priorityClassName", description="If specified, indicates the pod's priority. \"system-node-critical\" and \"system-cluster-critical\" are two special keywords which indicate the highest priorities with the former being the highest priority. Any other name must be defined by creating a PriorityClass object with that name. If not specified, the pod priority will be default or zero if there is no default.")
    ...
    __properties = ["labels", "annotations", "nodeSelector", "affinity", "tolerations", "nodeName", "serviceAccountName", "hostAliases", "securityContext",
                    "imagePullSecrets", "hostNetwork", "hostPID", "dnsPolicy", "dnsConfig", "schedulerName", "priorityClassName", "priority", "restartPolicy"]
