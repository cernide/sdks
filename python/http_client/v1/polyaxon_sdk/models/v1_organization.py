...
class V1Organization(BaseModel):
    ...
    __properties = ["user", "user_email", "name", "is_public", "created_at", "updated_at", "support_revoke_at",
                    "expiration", "role", "queue", "preset", "is_cloud_viewable", "archived_deletion_interval", "auth", "plan", "usage"]
