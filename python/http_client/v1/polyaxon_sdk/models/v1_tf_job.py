...
class V1TFJob(BaseModel):
    ...
    clean_pod_policy: Optional[V1CleanPodPolicy] = Field(
        None, alias="cleanPodPolicy")
    scheduling_policy: Optional[V1SchedulingPolicy] = Field(
        None, alias="schedulingPolicy")
    success_policy: Optional[StrictStr] = Field(None, alias="successPolicy")
    enable_dynamic_worker: Optional[StrictBool] = Field(
        None, alias="enableDynamicWorker")
    ...
    __properties = ["kind", "cleanPodPolicy", "schedulingPolicy", "successPolicy",
                    "enableDynamicWorker", "chief", "worker", "ps", "evaluator"]
