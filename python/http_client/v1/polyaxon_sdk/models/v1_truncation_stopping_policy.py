...
class V1TruncationStoppingPolicy(BaseModel):
    ...
    percent: Optional[StrictInt] = Field(
        None, description="The percentage of runs to stop, at each evaluation interval. e.g. 1 - 99.")
    evaluation_interval: Optional[StrictInt] = Field(
        None, alias="evaluationInterval", description="Interval/Frequency for applying the policy.")
    min_interval: Optional[StrictInt] = Field(None, alias="minInterval")
    min_samples: Optional[StrictInt] = Field(None, alias="minSamples")
    include_succeeded: Optional[StrictBool] = Field(
        None, alias="includeSucceeded")
    __properties = ["kind", "percent", "evaluationInterval",
                    "minInterval", "minSamples", "includeSucceeded"]
