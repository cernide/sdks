...
class V1IO(BaseModel):
    ...
    delay_validation: Optional[StrictBool] = Field(
        None, alias="delayValidation")
    options: Optional[conlist(Dict[str, Any])] = None
    __properties = ["name", "description", "type", "value", "isOptional", "isList", "isFlag",
                    "argFormat", "connection", "toInit", "toEnv", "validation", "delayValidation", "options"]
