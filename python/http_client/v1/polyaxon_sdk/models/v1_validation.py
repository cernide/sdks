...
class V1Validation(BaseModel):
    ...
    contains_keys: Optional[conlist(StrictStr)] = Field(
        None, alias="containsKeys")
    excludes_keys: Optional[conlist(StrictStr)] = Field(
        None, alias="excludesKeys")
    __properties = ["delay", "gt", "ge", "lt", "le", "multipleOf", "minDigits", "maxDigits", "decimalPlaces", "regex",
                    "minLength", "maxLength", "contains", "excludes", "options", "minItems", "maxItems", "keys", "containsKeys", "excludesKeys"]
