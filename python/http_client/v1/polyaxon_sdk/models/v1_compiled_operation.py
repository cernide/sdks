...
class V1CompiledOperation(BaseModel):
    ...
    __properties = ["version", "kind", "name", "description", "tags", "presets", "queue", "cache", "namespace", "termination", "plugins", "schedule", "events",
                    "build", "hooks", "dependencies", "trigger", "conditions", "skipOnUpstreamSkip", "matrix", "joins", "inputs", "outputs", "contexts", "isApproved", "cost", "run"]
