...
export default class ServiceAccountsV1Api {
    ...
    createServiceAccount(owner, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling createServiceAccount"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling createServiceAccount"
            );
        }
    ...
    createServiceAccountToken(owner, entity, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling createServiceAccountToken"
            );
        }
        // verify the required parameter 'entity' is set
        if (entity === undefined || entity === null) {
            throw new Error(
                "Missing the required parameter 'entity' when calling createServiceAccountToken"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling createServiceAccountToken"
            );
        }
    ...
    deleteServiceAccount(owner, uuid, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling deleteServiceAccount"
            );
        }
        // verify the required parameter 'uuid' is set
        if (uuid === undefined || uuid === null) {
            throw new Error(
                "Missing the required parameter 'uuid' when calling deleteServiceAccount"
            );
        }
    ...
    deleteServiceAccountToken(owner, entity, uuid, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling deleteServiceAccountToken"
            );
        }
        // verify the required parameter 'entity' is set
        if (entity === undefined || entity === null) {
            throw new Error(
                "Missing the required parameter 'entity' when calling deleteServiceAccountToken"
            );
        }
        // verify the required parameter 'uuid' is set
        if (uuid === undefined || uuid === null) {
            throw new Error(
                "Missing the required parameter 'uuid' when calling deleteServiceAccountToken"
            );
        }
    ...
    getServiceAccount(owner, uuid, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling getServiceAccount"
            );
        }
        // verify the required parameter 'uuid' is set
        if (uuid === undefined || uuid === null) {
    ...
    getServiceAccountToken(owner, entity, uuid, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling getServiceAccountToken"
            );
        }
        // verify the required parameter 'entity' is set
        if (entity === undefined || entity === null) {
            throw new Error(
                "Missing the required parameter 'entity' when calling getServiceAccountToken"
            );
        }
        // verify the required parameter 'uuid' is set
        if (uuid === undefined || uuid === null) {
            throw new Error(
                "Missing the required parameter 'uuid' when calling getServiceAccountToken"
            );
        }
    ...
    listServiceAccountNames(owner, opts, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling listServiceAccountNames"
            );
        }
    ...
    listServiceAccountTokens(owner, uuid, opts, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling listServiceAccountTokens"
            );
        }
        // verify the required parameter 'uuid' is set
        if (uuid === undefined || uuid === null) {
            throw new Error(
                "Missing the required parameter 'uuid' when calling listServiceAccountTokens"
            );
        }
    ...
    listServiceAccounts(owner, opts, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling listServiceAccounts"
            );
        }
    ...
    patchServiceAccount(owner, sa_uuid, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling patchServiceAccount"
            );
        }
        // verify the required parameter 'sa_uuid' is set
        if (sa_uuid === undefined || sa_uuid === null) {
            throw new Error(
                "Missing the required parameter 'sa_uuid' when calling patchServiceAccount"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling patchServiceAccount"
            );
        }
    ...
    patchServiceAccountToken(owner, entity, token_uuid, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling patchServiceAccountToken"
            );
        }
        // verify the required parameter 'entity' is set
        if (entity === undefined || entity === null) {
            throw new Error(
                "Missing the required parameter 'entity' when calling patchServiceAccountToken"
            );
        }
        // verify the required parameter 'token_uuid' is set
        if (token_uuid === undefined || token_uuid === null) {
            throw new Error(
                "Missing the required parameter 'token_uuid' when calling patchServiceAccountToken"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling patchServiceAccountToken"
            );
        }
    ...
    updateServiceAccount(owner, sa_uuid, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling updateServiceAccount"
            );
        }
        // verify the required parameter 'sa_uuid' is set
        if (sa_uuid === undefined || sa_uuid === null) {
            throw new Error(
                "Missing the required parameter 'sa_uuid' when calling updateServiceAccount"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling updateServiceAccount"
            );
        }
    ...
    updateServiceAccountToken(owner, entity, token_uuid, body, callback) {
        ...
        if (owner === undefined || owner === null) {
            throw new Error(
                "Missing the required parameter 'owner' when calling updateServiceAccountToken"
            );
        }
        // verify the required parameter 'entity' is set
        if (entity === undefined || entity === null) {
            throw new Error(
                "Missing the required parameter 'entity' when calling updateServiceAccountToken"
            );
        }
        // verify the required parameter 'token_uuid' is set
        if (token_uuid === undefined || token_uuid === null) {
            throw new Error(
                "Missing the required parameter 'token_uuid' when calling updateServiceAccountToken"
            );
        }
        // verify the required parameter 'body' is set
        if (body === undefined || body === null) {
            throw new Error(
                "Missing the required parameter 'body' when calling updateServiceAccountToken"
            );
        }
