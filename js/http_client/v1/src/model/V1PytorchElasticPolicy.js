...
class V1PytorchElasticPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("minReplicas")) {
                obj["minReplicas"] = ApiClient.convertToType(
                    data["minReplicas"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("maxReplicas")) {
                obj["maxReplicas"] = ApiClient.convertToType(
                    data["maxReplicas"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("rdvzBackend")) {
                obj["rdvzBackend"] = ApiClient.convertToType(
                    data["rdvzBackend"],
                    "String"
                );
            }
            if (data.hasOwnProperty("rdvzPort")) {
                obj["rdvzPort"] = ApiClient.convertToType(
                    data["rdvzPort"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("rdvzHost")) {
                obj["rdvzHost"] = ApiClient.convertToType(
                    data["rdvzHost"],
                    "String"
                );
            }
            if (data.hasOwnProperty("rdvzId")) {
                obj["rdvzId"] = ApiClient.convertToType(
                    data["rdvzId"],
                    "String"
                );
            }
            if (data.hasOwnProperty("rdvzConf")) {
                obj["rdvzConf"] = ApiClient.convertToType(data["rdvzConf"], [
                    Object,
                ]);
            }
            if (data.hasOwnProperty("standalone")) {
                obj["standalone"] = ApiClient.convertToType(
                    data["standalone"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("nProcPerNode")) {
                obj["nProcPerNode"] = ApiClient.convertToType(
                    data["nProcPerNode"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("maxRestarts")) {
                obj["maxRestarts"] = ApiClient.convertToType(
                    data["maxRestarts"],
                    "Number"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["rdvzBackend"] &&
            !(
                typeof data["rdvzBackend"] === "string" ||
                data["rdvzBackend"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `rdvzBackend` to be a primitive type in the JSON string but got " +
                    data["rdvzBackend"]
            );
        }
        // ensure the json data is a string
        if (
            data["rdvzHost"] &&
            !(
                typeof data["rdvzHost"] === "string" ||
                data["rdvzHost"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `rdvzHost` to be a primitive type in the JSON string but got " +
                    data["rdvzHost"]
            );
        }
        // ensure the json data is a string
        if (
            data["rdvzId"] &&
            !(
                typeof data["rdvzId"] === "string" ||
                data["rdvzId"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `rdvzId` to be a primitive type in the JSON string but got " +
                    data["rdvzId"]
            );
        }
        ...
        if (!Array.isArray(data["rdvzConf"])) {
            throw new Error(
                "Expected the field `rdvzConf` to be an array in the JSON data but got " +
                    data["rdvzConf"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["Metrics"])) {
            throw new Error(
                "Expected the field `Metrics` to be an array in the JSON data but got " +
                    data["Metrics"]
            );
        }
