...
class V1ClaimConnection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("volumeClaim")) {
                obj["volumeClaim"] = ApiClient.convertToType(
                    data["volumeClaim"],
                    "String"
                );
            }
            if (data.hasOwnProperty("mountPath")) {
                obj["mountPath"] = ApiClient.convertToType(
                    data["mountPath"],
                    "String"
                );
            }
            if (data.hasOwnProperty("readOnly")) {
                obj["readOnly"] = ApiClient.convertToType(
                    data["readOnly"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["volumeClaim"] &&
            !(
                typeof data["volumeClaim"] === "string" ||
                data["volumeClaim"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `volumeClaim` to be a primitive type in the JSON string but got " +
                    data["volumeClaim"]
            );
        }
        // ensure the json data is a string
        if (
            data["mountPath"] &&
            !(
                typeof data["mountPath"] === "string" ||
                data["mountPath"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `mountPath` to be a primitive type in the JSON string but got " +
                    data["mountPath"]
            );
        }
