    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("agent")) {
                obj["agent"] = V1SettingsCatalog.constructFromObject(
                    data["agent"]
                );
            }
            if (data.hasOwnProperty("queue")) {
                obj["queue"] = V1SettingsCatalog.constructFromObject(
                    data["queue"]
                );
            }
            if (data.hasOwnProperty("artifacts_store")) {
                obj["artifacts_store"] = V1SettingsCatalog.constructFromObject(
                    data["artifacts_store"]
                );
            }
            if (data.hasOwnProperty("tensorboard")) {
                obj["tensorboard"] = ApiClient.convertToType(
                    data["tensorboard"],
                    Object
                );
            }
            ...
            if (data.hasOwnProperty("component")) {
                obj["component"] = ApiClient.convertToType(
                    data["component"],
                    Object
                );
            }
            if (data.hasOwnProperty("models")) {
                obj["models"] = ApiClient.convertToType(data["models"], [
    ...
    static validateJSON(data) {
        ...
        if (data["models"]) {
            ...
            if (!Array.isArray(data["models"])) {
                throw new Error(
                    "Expected the field `models` to be an array in the JSON data but got " +
                        data["models"]
                );
            }
