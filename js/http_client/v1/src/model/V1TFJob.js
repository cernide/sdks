...
class V1TFJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("cleanPodPolicy")) {
                obj["cleanPodPolicy"] = V1CleanPodPolicy.constructFromObject(
                    data["cleanPodPolicy"]
                );
            }
            if (data.hasOwnProperty("schedulingPolicy")) {
                obj["schedulingPolicy"] =
                    V1SchedulingPolicy.constructFromObject(
                        data["schedulingPolicy"]
                    );
            }
            if (data.hasOwnProperty("successPolicy")) {
                obj["successPolicy"] = ApiClient.convertToType(
                    data["successPolicy"],
                    "String"
                );
            }
            if (data.hasOwnProperty("enableDynamicWorker")) {
                obj["enableDynamicWorker"] = ApiClient.convertToType(
                    data["enableDynamicWorker"],
                    "Boolean"
                );
            }
            ...
            if (data.hasOwnProperty("evaluator")) {
                obj["evaluator"] = V1KFReplica.constructFromObject(
                    data["evaluator"]
                );
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (
            data["successPolicy"] &&
            !(
                typeof data["successPolicy"] === "string" ||
                data["successPolicy"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `successPolicy` to be a primitive type in the JSON string but got " +
                    data["successPolicy"]
            );
        }
