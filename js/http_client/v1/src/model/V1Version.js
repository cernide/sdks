...
class V1Version {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("latest")) {
                obj["latest"] = ApiClient.convertToType(
                    data["latest"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["min"] &&
            !(typeof data["min"] === "string" || data["min"] instanceof String)
        ) {
            throw new Error(
                "Expected the field `min` to be a primitive type in the JSON string but got " +
                    data["min"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["latest"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `latest` to be a primitive type in the JSON string but got " +
                    data["latest"]
            );
        }
