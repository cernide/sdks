...
class V1UserSingup {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("password")) {
                obj["password"] = ApiClient.convertToType(
                    data["password"],
                    "String"
                );
            }
            if (data.hasOwnProperty("invitation_key")) {
                obj["invitation_key"] = ApiClient.convertToType(
                    data["invitation_key"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["invitation_key"] &&
            !(
                typeof data["invitation_key"] === "string" ||
                data["invitation_key"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `invitation_key` to be a primitive type in the JSON string but got " +
                    data["invitation_key"]
            );
        }
