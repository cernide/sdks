    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("version_api")) {
                obj["version_api"] = ApiClient.convertToType(
                    data["version_api"],
                    Object
                );
            }
            ...
            if (data.hasOwnProperty("is_replica")) {
                obj["is_replica"] = ApiClient.convertToType(
                    data["is_replica"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("is_ui_managed")) {
                obj["is_ui_managed"] = ApiClient.convertToType(
                    data["is_ui_managed"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("hostname")) {
                obj["hostname"] = ApiClient.convertToType(
                    data["hostname"],
                    "String"
                );
            }
            if (data.hasOwnProperty("settings")) {
                obj["settings"] = ApiClient.convertToType(
                    data["settings"],
                    Object
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["version"] instanceof String
            )
        ) {
            throw new Error(
        ...
        if (
            ...
            !(
                ...
                data["hostname"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `hostname` to be a primitive type in the JSON string but got " +
                    data["hostname"]
            );
        }
