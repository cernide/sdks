...
class ProtobufAny {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("type_url")) {
                obj["type_url"] = ApiClient.convertToType(
                    data["type_url"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["type_url"] &&
            !(
                typeof data["type_url"] === "string" ||
                data["type_url"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `type_url` to be a primitive type in the JSON string but got " +
                    data["type_url"]
            );
        }
