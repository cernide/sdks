...
class V1SchedulingPolicy {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("minAvailable")) {
                obj["minAvailable"] = ApiClient.convertToType(
                    data["minAvailable"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("minResources")) {
                obj["minResources"] = ApiClient.convertToType(
                    data["minResources"],
                    Object
                );
            }
            if (data.hasOwnProperty("priorityClass")) {
                obj["priorityClass"] = ApiClient.convertToType(
                    data["priorityClass"],
                    "String"
                );
            }
            if (data.hasOwnProperty("scheduleTimeoutSeconds")) {
                obj["scheduleTimeoutSeconds"] = ApiClient.convertToType(
                    data["scheduleTimeoutSeconds"],
                    "Number"
                );
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (
            data["priorityClass"] &&
            !(
                typeof data["priorityClass"] === "string" ||
                data["priorityClass"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `priorityClass` to be a primitive type in the JSON string but got " +
                    data["priorityClass"]
            );
        }
