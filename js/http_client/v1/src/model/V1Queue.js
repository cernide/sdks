    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("resource")) {
                obj["resource"] = ApiClient.convertToType(
                    data["resource"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["agent"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `agent` to be a primitive type in the JSON string but got " +
                    data["agent"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            ...
            !(
                ...
                data["resource"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `resource` to be a primitive type in the JSON string but got " +
                    data["resource"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["quota"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `quota` to be a primitive type in the JSON string but got " +
                    data["quota"]
            );
        }
