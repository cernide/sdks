    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("replicas")) {
                obj["replicas"] = ApiClient.convertToType(
                    data["replicas"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("groupName")) {
                obj["groupName"] = ApiClient.convertToType(
                    data["groupName"],
                    "String"
                );
            }
            if (data.hasOwnProperty("rayStartParams")) {
                obj["rayStartParams"] = ApiClient.convertToType(
                    data["rayStartParams"],
                    { String: "String" }
                );
            }
            if (data.hasOwnProperty("environment")) {
                obj["environment"] = V1Environment.constructFromObject(
                    data["environment"]
                );
            }
            ...
            if (data.hasOwnProperty("volumes")) {
                obj["volumes"] = ApiClient.convertToType(data["volumes"], [
                    Object,
                ]);
            }
            ...
            if (data.hasOwnProperty("sidecars")) {
                obj["sidecars"] = ApiClient.convertToType(data["sidecars"], [
                    Object,
                ]);
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["groupName"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `groupName` to be a primitive type in the JSON string but got " +
                    data["groupName"]
            );
        }
        ...
        if (!Array.isArray(data["volumes"])) {
            throw new Error(
                "Expected the field `volumes` to be an array in the JSON data but got " +
                    data["volumes"]
            );
        }
        if (data["init"]) {
            ...
            if (!Array.isArray(data["init"])) {
                throw new Error(
                    "Expected the field `init` to be an array in the JSON data but got " +
                        data["init"]
                );
            }
        ...
        if (!Array.isArray(data["sidecars"])) {
            throw new Error(
                "Expected the field `sidecars` to be an array in the JSON data but got " +
                    data["sidecars"]
            );
        }
