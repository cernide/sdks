...
class V1RunEdge {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("downstream")) {
                obj["downstream"] = V1Run.constructFromObject(
                    data["downstream"]
                );
            }
            ...
            if (data.hasOwnProperty("statuses")) {
                obj["statuses"] = ApiClient.convertToType(data["statuses"], [
                    V1Statuses,
                ]);
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["statuses"])) {
            throw new Error(
                "Expected the field `statuses` to be an array in the JSON data but got " +
                    data["statuses"]
            );
        }
