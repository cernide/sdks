    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("last_time")) {
                obj["last_time"] = ApiClient.convertToType(
                    data["last_time"],
                    "Date"
                );
            }
            if (data.hasOwnProperty("last_file")) {
                obj["last_file"] = ApiClient.convertToType(
                    data["last_file"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        if (data["logs"]) {
            ...
            if (!Array.isArray(data["logs"])) {
                throw new Error(
                    "Expected the field `logs` to be an array in the JSON data but got " +
                        data["logs"]
                );
            }
        ...
        if (
            data["last_file"] &&
            !(
                typeof data["last_file"] === "string" ||
                data["last_file"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `last_file` to be a primitive type in the JSON string but got " +
                    data["last_file"]
            );
        }
        // ensure the json data is an array
