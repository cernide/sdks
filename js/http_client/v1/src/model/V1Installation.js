...
class V1Installation {
    ...
    static validateJSON(data) {
        ...
        if (
            data["dist"] &&
            !(
                typeof data["dist"] === "string" ||
                data["dist"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `dist` to be a primitive type in the JSON string but got " +
                    data["dist"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            ...
            !(
                ...
                data["hmac"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `hmac` to be a primitive type in the JSON string but got " +
                    data["hmac"]
            );
        }
        // ensure the json data is a string
        ...
        if (!Array.isArray(data["auth"])) {
            throw new Error(
                "Expected the field `auth` to be an array in the JSON data but got " +
                    data["auth"]
            );
        }
