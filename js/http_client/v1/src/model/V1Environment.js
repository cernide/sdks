...
class V1Environment {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("annotations")) {
                obj["annotations"] = ApiClient.convertToType(
                    data["annotations"],
                    { String: "String" }
                );
            }
            if (data.hasOwnProperty("nodeSelector")) {
                obj["nodeSelector"] = ApiClient.convertToType(
                    data["nodeSelector"],
                    { String: "String" }
                );
            }
            if (data.hasOwnProperty("affinity")) {
                obj["affinity"] = ApiClient.convertToType(
                    data["affinity"],
                    Object
                );
            }
            if (data.hasOwnProperty("tolerations")) {
                obj["tolerations"] = ApiClient.convertToType(
                    data["tolerations"],
                    [Object]
                );
            }
            if (data.hasOwnProperty("nodeName")) {
                obj["nodeName"] = ApiClient.convertToType(
                    data["nodeName"],
                    "String"
                );
            }
            if (data.hasOwnProperty("serviceAccountName")) {
                obj["serviceAccountName"] = ApiClient.convertToType(
                    data["serviceAccountName"],
                    "String"
                );
            }
            if (data.hasOwnProperty("hostAliases")) {
                obj["hostAliases"] = ApiClient.convertToType(
                    data["hostAliases"],
                    [Object]
                );
            }
            if (data.hasOwnProperty("securityContext")) {
                obj["securityContext"] = ApiClient.convertToType(
                    data["securityContext"],
                    Object
                );
            }
            if (data.hasOwnProperty("imagePullSecrets")) {
                obj["imagePullSecrets"] = ApiClient.convertToType(
                    data["imagePullSecrets"],
                    ["String"]
                );
            }
            if (data.hasOwnProperty("hostNetwork")) {
                obj["hostNetwork"] = ApiClient.convertToType(
                    data["hostNetwork"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("hostPID")) {
                obj["hostPID"] = ApiClient.convertToType(
                    data["hostPID"],
                    "String"
                );
            }
            if (data.hasOwnProperty("dnsPolicy")) {
                obj["dnsPolicy"] = ApiClient.convertToType(
                    data["dnsPolicy"],
                    "String"
                );
            }
            if (data.hasOwnProperty("dnsConfig")) {
                obj["dnsConfig"] = ApiClient.convertToType(
                    data["dnsConfig"],
                    Object
                );
            }
            if (data.hasOwnProperty("schedulerName")) {
                obj["schedulerName"] = ApiClient.convertToType(
                    data["schedulerName"],
                    "String"
                );
            }
            if (data.hasOwnProperty("priorityClassName")) {
                obj["priorityClassName"] = ApiClient.convertToType(
                    data["priorityClassName"],
                    "String"
                );
            }
            if (data.hasOwnProperty("priority")) {
                obj["priority"] = ApiClient.convertToType(
                    data["priority"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("restartPolicy")) {
                obj["restartPolicy"] = ApiClient.convertToType(
                    data["restartPolicy"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["tolerations"])) {
            throw new Error(
                "Expected the field `tolerations` to be an array in the JSON data but got " +
                    data["tolerations"]
            );
        }
        ...
        if (
            ...
            !(
                ...
                data["nodeName"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `nodeName` to be a primitive type in the JSON string but got " +
                    data["nodeName"]
            );
        }
        // ensure the json data is a string
        if (
            data["serviceAccountName"] &&
            !(
                typeof data["serviceAccountName"] === "string" ||
                data["serviceAccountName"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `serviceAccountName` to be a primitive type in the JSON string but got " +
                    data["serviceAccountName"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["hostAliases"])) {
            throw new Error(
                "Expected the field `hostAliases` to be an array in the JSON data but got " +
                    data["hostAliases"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["imagePullSecrets"])) {
            throw new Error(
                "Expected the field `imagePullSecrets` to be an array in the JSON data but got " +
                    data["imagePullSecrets"]
            );
        }
        // ensure the json data is a string
        if (
            data["hostPID"] &&
            !(
                typeof data["hostPID"] === "string" ||
                data["hostPID"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `hostPID` to be a primitive type in the JSON string but got " +
                    data["hostPID"]
            );
        }
        // ensure the json data is a string
        if (
            data["dnsPolicy"] &&
            !(
                typeof data["dnsPolicy"] === "string" ||
                data["dnsPolicy"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `dnsPolicy` to be a primitive type in the JSON string but got " +
                    data["dnsPolicy"]
            );
        }
        // ensure the json data is a string
        if (
            data["schedulerName"] &&
            !(
                typeof data["schedulerName"] === "string" ||
                data["schedulerName"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `schedulerName` to be a primitive type in the JSON string but got " +
                    data["schedulerName"]
            );
        }
        // ensure the json data is a string
        if (
            data["priorityClassName"] &&
            !(
                typeof data["priorityClassName"] === "string" ||
                data["priorityClassName"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `priorityClassName` to be a primitive type in the JSON string but got " +
                    data["priorityClassName"]
            );
        }
        // ensure the json data is a string
        if (
            data["restartPolicy"] &&
            !(
                typeof data["restartPolicy"] === "string" ||
                data["restartPolicy"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `restartPolicy` to be a primitive type in the JSON string but got " +
                    data["restartPolicy"]
            );
        }
