...
class V1EventHistogram {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("counts")) {
                obj["counts"] = ApiClient.convertToType(data["counts"], [
                    "Number",
                ]);
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["values"])) {
            throw new Error(
                "Expected the field `values` to be an array in the JSON data but got " +
                    data["values"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["counts"])) {
            throw new Error(
                "Expected the field `counts` to be an array in the JSON data but got " +
                    data["counts"]
            );
        }
