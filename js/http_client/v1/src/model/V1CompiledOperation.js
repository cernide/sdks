    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("contexts")) {
                obj["contexts"] = ApiClient.convertToType(data["contexts"], [
                    V1IO,
                ]);
            }
    ...
    static validateJSON(data) {
        ...
        if (data["inputs"]) {
            ...
            if (!Array.isArray(data["inputs"])) {
                throw new Error(
                    "Expected the field `inputs` to be an array in the JSON data but got " +
                        data["inputs"]
                );
            }
        ...
        if (data["outputs"]) {
            ...
            if (!Array.isArray(data["outputs"])) {
                throw new Error(
                    "Expected the field `outputs` to be an array in the JSON data but got " +
                        data["outputs"]
                );
            }
        ...
        if (data["contexts"]) {
            ...
            if (!Array.isArray(data["contexts"])) {
                throw new Error(
                    "Expected the field `contexts` to be an array in the JSON data but got " +
                        data["contexts"]
                );
            }
