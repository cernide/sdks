    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("connection")) {
                obj["connection"] = ApiClient.convertToType(
                    data["connection"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("kind")) {
                obj["kind"] = V1ProjectVersionKind.constructFromObject(
                    data["kind"]
                );
            }
            if (data.hasOwnProperty("stage_conditions")) {
                obj["stage_conditions"] = ApiClient.convertToType(
                    data["stage_conditions"],
                    [V1StageCondition]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["connection"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `connection` to be a primitive type in the JSON string but got " +
                    data["connection"]
            );
        }
        // ensure the json data is a string
        if (
            data["run"] &&
            !(typeof data["run"] === "string" || data["run"] instanceof String)
        ) {
            throw new Error(
                "Expected the field `run` to be a primitive type in the JSON string but got " +
                    data["run"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["artifacts"])) {
            throw new Error(
                "Expected the field `artifacts` to be an array in the JSON data but got " +
                    data["artifacts"]
            );
        }
        if (data["stage_conditions"]) {
            // data not null
            // ensure the json data is an array
            if (!Array.isArray(data["stage_conditions"])) {
                throw new Error(
                    "Expected the field `stage_conditions` to be an array in the JSON data but got " +
                        data["stage_conditions"]
                );
            }
        ...
        if (
            ...
            !(
                ...
                data["state"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `state` to be a primitive type in the JSON string but got " +
                    data["state"]
            );
        }
        // ensure the json data is a string
