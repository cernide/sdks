    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("optimization")) {
                obj["optimization"] = V1Optimization.constructFromObject(
                    data["optimization"]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["metric"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `metric` to be a primitive type in the JSON string but got " +
                    data["metric"]
            );
        }
        // ensure the json data is a string
