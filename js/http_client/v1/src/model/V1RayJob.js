    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("entrypoint")) {
                obj["entrypoint"] = ApiClient.convertToType(
                    data["entrypoint"],
                    "String"
                );
            }
            if (data.hasOwnProperty("runtimeEnv")) {
                obj["runtimeEnv"] = ApiClient.convertToType(
                    data["runtimeEnv"],
                    Object
                );
            }
            ...
            if (data.hasOwnProperty("rayVersion")) {
                obj["rayVersion"] = ApiClient.convertToType(
                    data["rayVersion"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["entrypoint"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `entrypoint` to be a primitive type in the JSON string but got " +
                    data["entrypoint"]
            );
        }
        // ensure the json data is a string
        if (
            data["rayVersion"] &&
            !(
                typeof data["rayVersion"] === "string" ||
                data["rayVersion"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `rayVersion` to be a primitive type in the JSON string but got " +
                    data["rayVersion"]
            );
        }
        ...
        if (data["workers"]) {
            ...
            if (!Array.isArray(data["workers"])) {
                throw new Error(
                    "Expected the field `workers` to be an array in the JSON data but got " +
                        data["workers"]
                );
            }
