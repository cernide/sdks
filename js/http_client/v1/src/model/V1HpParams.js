    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("pchoice")) {
                obj["pchoice"] = V1HpPChoice.constructFromObject(
                    data["pchoice"]
                );
            }
            ...
            if (data.hasOwnProperty("linspace")) {
                obj["linspace"] = V1HpLinSpace.constructFromObject(
                    data["linspace"]
                );
            }
            if (data.hasOwnProperty("logspace")) {
                obj["logspace"] = V1HpLogSpace.constructFromObject(
                    data["logspace"]
                );
            }
            if (data.hasOwnProperty("geomspace")) {
                obj["geomspace"] = V1HpGeomSpace.constructFromObject(
                    data["geomspace"]
                );
            }
            if (data.hasOwnProperty("uniform")) {
                obj["uniform"] = V1HpUniform.constructFromObject(
                    data["uniform"]
                );
            }
            if (data.hasOwnProperty("quniform")) {
                obj["quniform"] = V1HpQUniform.constructFromObject(
                    data["quniform"]
                );
            }
            if (data.hasOwnProperty("loguniform")) {
                obj["loguniform"] = V1HpLogUniform.constructFromObject(
                    data["loguniform"]
                );
            }
            if (data.hasOwnProperty("qloguniform")) {
                obj["qloguniform"] = V1HpQLogUniform.constructFromObject(
                    data["qloguniform"]
                );
            }
            ...
            if (data.hasOwnProperty("qnormal")) {
                obj["qnormal"] = V1HpQNormal.constructFromObject(
                    data["qnormal"]
                );
            }
            if (data.hasOwnProperty("lognormal")) {
                obj["lognormal"] = V1HpLogNormal.constructFromObject(
                    data["lognormal"]
                );
            }
            if (data.hasOwnProperty("qlognormal")) {
                obj["qlognormal"] = V1HpQLogNormal.constructFromObject(
                    data["qlognormal"]
                );
            }
            if (data.hasOwnProperty("daterange")) {
                obj["daterange"] = V1HpDateRange.constructFromObject(
                    data["daterange"]
                );
            }
            if (data.hasOwnProperty("datetimerange")) {
                obj["datetimerange"] = V1HpDateTimeRange.constructFromObject(
                    data["datetimerange"]
                );
            }
        }
