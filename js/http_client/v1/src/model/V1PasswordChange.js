...
class V1PasswordChange {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("old_password")) {
                obj["old_password"] = ApiClient.convertToType(
                    data["old_password"],
                    "String"
                );
            }
            if (data.hasOwnProperty("new_password1")) {
                obj["new_password1"] = ApiClient.convertToType(
                    data["new_password1"],
                    "String"
                );
            }
            if (data.hasOwnProperty("new_password2")) {
                obj["new_password2"] = ApiClient.convertToType(
                    data["new_password2"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["old_password"] &&
            !(
                typeof data["old_password"] === "string" ||
                data["old_password"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `old_password` to be a primitive type in the JSON string but got " +
                    data["old_password"]
            );
        }
        // ensure the json data is a string
        if (
            data["new_password1"] &&
            !(
                typeof data["new_password1"] === "string" ||
                data["new_password1"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `new_password1` to be a primitive type in the JSON string but got " +
                    data["new_password1"]
            );
        }
        // ensure the json data is a string
        if (
            data["new_password2"] &&
            !(
                typeof data["new_password2"] === "string" ||
                data["new_password2"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `new_password2` to be a primitive type in the JSON string but got " +
                    data["new_password2"]
            );
        }
