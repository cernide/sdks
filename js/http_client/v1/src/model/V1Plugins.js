    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("docker")) {
                obj["docker"] = ApiClient.convertToType(
                    data["docker"],
                    "Boolean"
                );
            }
            ...
            if (data.hasOwnProperty("mountArtifactsStore")) {
                obj["mountArtifactsStore"] = ApiClient.convertToType(
                    data["mountArtifactsStore"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("collectArtifacts")) {
                obj["collectArtifacts"] = ApiClient.convertToType(
                    data["collectArtifacts"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("collectLogs")) {
                obj["collectLogs"] = ApiClient.convertToType(
                    data["collectLogs"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("collectResources")) {
                obj["collectResources"] = ApiClient.convertToType(
                    data["collectResources"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("syncStatuses")) {
                obj["syncStatuses"] = ApiClient.convertToType(
                    data["syncStatuses"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("autoResume")) {
                obj["autoResume"] = ApiClient.convertToType(
                    data["autoResume"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("logLevel")) {
                obj["logLevel"] = ApiClient.convertToType(
                    data["logLevel"],
                    "String"
                );
            }
            if (data.hasOwnProperty("externalHost")) {
                obj["externalHost"] = ApiClient.convertToType(
                    data["externalHost"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("sidecar")) {
                obj["sidecar"] = V1PolyaxonSidecarContainer.constructFromObject(
                    data["sidecar"]
                );
            }
            if (data.hasOwnProperty("notifications")) {
                obj["notifications"] = ApiClient.convertToType(
                    data["notifications"],
                    [V1Notification]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["logLevel"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `logLevel` to be a primitive type in the JSON string but got " +
                    data["logLevel"]
            );
        }
