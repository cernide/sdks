    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("scheduler")) {
                obj["scheduler"] = V1KFReplica.constructFromObject(
                    data["scheduler"]
                );
            }
            ...
            if (data.hasOwnProperty("tuner_tracker")) {
                obj["tuner_tracker"] = V1KFReplica.constructFromObject(
                    data["tuner_tracker"]
                );
            }
            if (data.hasOwnProperty("tuner_server")) {
                obj["tuner_server"] = V1KFReplica.constructFromObject(
                    data["tuner_server"]
                );
            }
