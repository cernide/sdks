    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("offset")) {
                obj["offset"] = ApiClient.convertToType(
                    data["offset"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("groupby")) {
                obj["groupby"] = ApiClient.convertToType(
                    data["groupby"],
                    "String"
                );
            }
            if (data.hasOwnProperty("columns")) {
                obj["columns"] = ApiClient.convertToType(
                    data["columns"],
                    "String"
                );
            }
            if (data.hasOwnProperty("layout")) {
                obj["layout"] = ApiClient.convertToType(
                    data["layout"],
                    "String"
                );
            }
            if (data.hasOwnProperty("sections")) {
                obj["sections"] = ApiClient.convertToType(
                    data["sections"],
                    "String"
                );
            }
            if (data.hasOwnProperty("compares")) {
                obj["compares"] = ApiClient.convertToType(
                    data["compares"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("events")) {
                obj["events"] = V1DashboardSpec.constructFromObject(
                    data["events"]
                );
            }
            if (data.hasOwnProperty("histograms")) {
                obj["histograms"] = ApiClient.convertToType(
                    data["histograms"],
                    Object
                );
            }
            ...
            if (data.hasOwnProperty("analytics")) {
                obj["analytics"] = V1AnalyticsSpec.constructFromObject(
                    data["analytics"]
                );
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["query"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `query` to be a primitive type in the JSON string but got " +
                    data["query"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["sort"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `sort` to be a primitive type in the JSON string but got " +
                    data["sort"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["groupby"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `groupby` to be a primitive type in the JSON string but got " +
                    data["groupby"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["columns"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `columns` to be a primitive type in the JSON string but got " +
                    data["columns"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["layout"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `layout` to be a primitive type in the JSON string but got " +
                    data["layout"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["sections"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `sections` to be a primitive type in the JSON string but got " +
                    data["sections"]
            );
        }
        // ensure the json data is a string
        if (
            data["compares"] &&
            !(
                typeof data["compares"] === "string" ||
                data["compares"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `compares` to be a primitive type in the JSON string but got " +
                    data["compares"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["heat"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `heat` to be a primitive type in the JSON string but got " +
                    data["heat"]
            );
        }
