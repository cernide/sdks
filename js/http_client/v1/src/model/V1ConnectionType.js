...
class V1ConnectionType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("secret")) {
                obj["secret"] = V1ConnectionResource.constructFromObject(
                    data["secret"]
                );
            }
            if (data.hasOwnProperty("configMap")) {
                obj["configMap"] = V1ConnectionResource.constructFromObject(
                    data["configMap"]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["env"])) {
            throw new Error(
                "Expected the field `env` to be an array in the JSON data but got " +
                    data["env"]
            );
        }
