...
class V1Service {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("ports")) {
                obj["ports"] = ApiClient.convertToType(data["ports"], [
                    "Number",
                ]);
            }
            if (data.hasOwnProperty("rewritePath")) {
                obj["rewritePath"] = ApiClient.convertToType(
                    data["rewritePath"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("isExternal")) {
                obj["isExternal"] = ApiClient.convertToType(
                    data["isExternal"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["ports"])) {
            throw new Error(
                "Expected the field `ports` to be an array in the JSON data but got " +
                    data["ports"]
            );
        }
