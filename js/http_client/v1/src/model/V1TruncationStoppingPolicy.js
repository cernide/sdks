    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("percent")) {
                obj["percent"] = ApiClient.convertToType(
                    data["percent"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("evaluationInterval")) {
                obj["evaluationInterval"] = ApiClient.convertToType(
                    data["evaluationInterval"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("minInterval")) {
                obj["minInterval"] = ApiClient.convertToType(
                    data["minInterval"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("minSamples")) {
                obj["minSamples"] = ApiClient.convertToType(
                    data["minSamples"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("includeSucceeded")) {
                obj["includeSucceeded"] = ApiClient.convertToType(
                    data["includeSucceeded"],
                    "Boolean"
                );
            }
        }
