    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("event_action")) {
                obj["event_action"] = ApiClient.convertToType(
                    data["event_action"],
                    "String"
                );
            }
            if (data.hasOwnProperty("event_subject")) {
                obj["event_subject"] = ApiClient.convertToType(
                    data["event_subject"],
                    "String"
                );
            }
            if (data.hasOwnProperty("object_name")) {
                obj["object_name"] = ApiClient.convertToType(
                    data["object_name"],
                    "String"
                );
            }
            if (data.hasOwnProperty("object_uuid")) {
                obj["object_uuid"] = ApiClient.convertToType(
                    data["object_uuid"],
                    "String"
                );
            }
            if (data.hasOwnProperty("object_parent")) {
                obj["object_parent"] = ApiClient.convertToType(
                    data["object_parent"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["actor"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `actor` to be a primitive type in the JSON string but got " +
                    data["actor"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            data["event_action"] &&
            !(
                typeof data["event_action"] === "string" ||
                data["event_action"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `event_action` to be a primitive type in the JSON string but got " +
                    data["event_action"]
            );
        }
        // ensure the json data is a string
        if (
            data["event_subject"] &&
            !(
                typeof data["event_subject"] === "string" ||
                data["event_subject"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `event_subject` to be a primitive type in the JSON string but got " +
                    data["event_subject"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["object_name"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `object_name` to be a primitive type in the JSON string but got " +
                    data["object_name"]
            );
        }
        // ensure the json data is a string
        if (
            data["object_uuid"] &&
            !(
                typeof data["object_uuid"] === "string" ||
                data["object_uuid"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `object_uuid` to be a primitive type in the JSON string but got " +
                    data["object_uuid"]
            );
        }
        // ensure the json data is a string
        if (
            data["object_parent"] &&
            !(
                typeof data["object_parent"] === "string" ||
                data["object_parent"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `object_parent` to be a primitive type in the JSON string but got " +
                    data["object_parent"]
            );
        }
