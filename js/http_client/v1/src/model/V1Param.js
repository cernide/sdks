...
class V1Param {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("contextOnly")) {
                obj["contextOnly"] = ApiClient.convertToType(
                    data["contextOnly"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["ref"] &&
            !(typeof data["ref"] === "string" || data["ref"] instanceof String)
        ) {
            throw new Error(
                "Expected the field `ref` to be a primitive type in the JSON string but got " +
                    data["ref"]
            );
        }
        // ensure the json data is a string
