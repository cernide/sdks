...
class V1PytorchJob {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("elasticPolicy")) {
                obj["elasticPolicy"] =
                    V1PytorchElasticPolicy.constructFromObject(
                        data["elasticPolicy"]
                    );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["nProcPerNode"] &&
            !(
                typeof data["nProcPerNode"] === "string" ||
                data["nProcPerNode"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `nProcPerNode` to be a primitive type in the JSON string but got " +
                    data["nProcPerNode"]
            );
        }
