    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("startAt")) {
                obj["startAt"] = ApiClient.convertToType(
                    data["startAt"],
                    "Date"
                );
            }
            ...
            if (data.hasOwnProperty("maxRuns")) {
                obj["maxRuns"] = ApiClient.convertToType(
                    data["maxRuns"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("dependsOnPast")) {
                obj["dependsOnPast"] = ApiClient.convertToType(
                    data["dependsOnPast"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["cron"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `cron` to be a primitive type in the JSON string but got " +
                    data["cron"]
            );
        }
