...
class V1TeamMember {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("org_role")) {
                obj["org_role"] = ApiClient.convertToType(
                    data["org_role"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["org_role"] &&
            !(
                typeof data["org_role"] === "string" ||
                data["org_role"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `org_role` to be a primitive type in the JSON string but got " +
                    data["org_role"]
            );
        }
