...
class V1Event {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("metric")) {
                obj["metric"] = ApiClient.convertToType(
                    data["metric"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("histogram")) {
                obj["histogram"] = V1EventHistogram.constructFromObject(
                    data["histogram"]
                );
            }
            ...
            if (data.hasOwnProperty("artifact")) {
                obj["artifact"] = V1EventArtifact.constructFromObject(
                    data["artifact"]
                );
            }
            if (data.hasOwnProperty("dataframe")) {
                obj["dataframe"] = V1EventDataframe.constructFromObject(
                    data["dataframe"]
                );
            }
            ...
            if (data.hasOwnProperty("confusion")) {
                obj["confusion"] = V1EventConfusionMatrix.constructFromObject(
                    data["confusion"]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            throw new Error(
                "Expected the field `html` to be a primitive type in the JSON string but got " +
                    data["html"]
            );
        }
        // ensure the json data is a string
