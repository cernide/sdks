    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("timestamp")) {
                obj["timestamp"] = ApiClient.convertToType(
                    data["timestamp"],
                    "Date"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["node"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `node` to be a primitive type in the JSON string but got " +
                    data["node"]
            );
        }
        // ensure the json data is a string
        if (
            data["pod"] &&
            !(typeof data["pod"] === "string" || data["pod"] instanceof String)
        ) {
            throw new Error(
                "Expected the field `pod` to be a primitive type in the JSON string but got " +
                    data["pod"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["container"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `container` to be a primitive type in the JSON string but got " +
                    data["container"]
            );
        }
        // ensure the json data is a string
