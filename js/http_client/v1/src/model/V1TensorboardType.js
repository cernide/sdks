...
class V1TensorboardType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("uuids")) {
                obj["uuids"] = ApiClient.convertToType(data["uuids"], [
                    "String",
                ]);
            }
            if (data.hasOwnProperty("use_names")) {
                obj["use_names"] = ApiClient.convertToType(
                    data["use_names"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("path_prefix")) {
                obj["path_prefix"] = ApiClient.convertToType(
                    data["path_prefix"],
                    "String"
                );
            }
            if (data.hasOwnProperty("plugins")) {
                obj["plugins"] = ApiClient.convertToType(
                    data["plugins"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["uuids"])) {
            throw new Error(
                "Expected the field `uuids` to be an array in the JSON data but got " +
                    data["uuids"]
            );
        }
        ...
        if (
            data["path_prefix"] &&
            !(
                typeof data["path_prefix"] === "string" ||
                data["path_prefix"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `path_prefix` to be a primitive type in the JSON string but got " +
                    data["path_prefix"]
            );
        }
        // ensure the json data is a string
        if (
            data["plugins"] &&
            !(
                typeof data["plugins"] === "string" ||
                data["plugins"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `plugins` to be a primitive type in the JSON string but got " +
                    data["plugins"]
            );
        }
