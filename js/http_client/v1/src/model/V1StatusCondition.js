    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("reason")) {
                obj["reason"] = ApiClient.convertToType(
                    data["reason"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("last_update_time")) {
                obj["last_update_time"] = ApiClient.convertToType(
                    data["last_update_time"],
                    "Date"
                );
            }
            if (data.hasOwnProperty("last_transition_time")) {
                obj["last_transition_time"] = ApiClient.convertToType(
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["reason"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `reason` to be a primitive type in the JSON string but got " +
                    data["reason"]
            );
        }
        // ensure the json data is a string
