...
class V1WasbType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("storageAccount")) {
                obj["storageAccount"] = ApiClient.convertToType(
                    data["storageAccount"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["storageAccount"] &&
            !(
                typeof data["storageAccount"] === "string" ||
                data["storageAccount"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `storageAccount` to be a primitive type in the JSON string but got " +
                    data["storageAccount"]
            );
        }
