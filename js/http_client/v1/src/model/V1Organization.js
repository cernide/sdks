    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("user_email")) {
                obj["user_email"] = ApiClient.convertToType(
                    data["user_email"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("support_revoke_at")) {
                obj["support_revoke_at"] = ApiClient.convertToType(
                    data["support_revoke_at"],
                    "Date"
                );
            }
            if (data.hasOwnProperty("expiration")) {
                obj["expiration"] = ApiClient.convertToType(
                    data["expiration"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("is_cloud_viewable")) {
                obj["is_cloud_viewable"] = ApiClient.convertToType(
                    data["is_cloud_viewable"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["user_email"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `user_email` to be a primitive type in the JSON string but got " +
                    data["user_email"]
            );
        }
        // ensure the json data is a string
