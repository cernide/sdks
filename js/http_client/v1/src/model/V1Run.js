    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("schedule_at")) {
                obj["schedule_at"] = ApiClient.convertToType(
                    data["schedule_at"],
                    "Date"
                );
            }
            ...
            if (data.hasOwnProperty("started_at")) {
                obj["started_at"] = ApiClient.convertToType(
                    data["started_at"],
                    "Date"
                );
            }
            if (data.hasOwnProperty("finished_at")) {
                obj["finished_at"] = ApiClient.convertToType(
                    data["finished_at"],
                    "Date"
                );
            }
            if (data.hasOwnProperty("wait_time")) {
                obj["wait_time"] = ApiClient.convertToType(
                    data["wait_time"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("duration")) {
                obj["duration"] = ApiClient.convertToType(
                    data["duration"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("managed_by")) {
                obj["managed_by"] = V1ManagedBy.constructFromObject(
                    data["managed_by"]
                );
            }
            if (data.hasOwnProperty("is_managed")) {
                obj["is_managed"] = ApiClient.convertToType(
                    data["is_managed"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("is_approved")) {
                obj["is_approved"] = ApiClient.convertToType(
                    data["is_approved"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("pending")) {
                obj["pending"] = V1RunPending.constructFromObject(
                    data["pending"]
                );
            }
            if (data.hasOwnProperty("content")) {
                obj["content"] = ApiClient.convertToType(
                    data["content"],
                    "String"
                );
            }
            if (data.hasOwnProperty("raw_content")) {
                obj["raw_content"] = ApiClient.convertToType(
                    data["raw_content"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("bookmarked")) {
                obj["bookmarked"] = ApiClient.convertToType(
                    data["bookmarked"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("live_state")) {
                obj["live_state"] = ApiClient.convertToType(
                    data["live_state"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("readme")) {
                obj["readme"] = ApiClient.convertToType(
                    data["readme"],
                    "String"
                );
            }
            if (data.hasOwnProperty("meta_info")) {
                obj["meta_info"] = ApiClient.convertToType(
                    data["meta_info"],
                    Object
                );
            }
            ...
            if (data.hasOwnProperty("outputs")) {
                obj["outputs"] = ApiClient.convertToType(
                    data["outputs"],
                    Object
                );
            }
            if (data.hasOwnProperty("original")) {
                obj["original"] = V1Cloning.constructFromObject(
                    data["original"]
                );
            }
            if (data.hasOwnProperty("pipeline")) {
                obj["pipeline"] = V1Pipeline.constructFromObject(
                    data["pipeline"]
                );
            }
            if (data.hasOwnProperty("status_conditions")) {
                obj["status_conditions"] = ApiClient.convertToType(
                    data["status_conditions"],
                    [V1StatusCondition]
                );
            }
            ...
            if (data.hasOwnProperty("contributors")) {
                obj["contributors"] = ApiClient.convertToType(
                    data["contributors"],
                    [Object]
                );
            }
            if (data.hasOwnProperty("settings")) {
                obj["settings"] = V1RunSettings.constructFromObject(
                    data["settings"]
                );
            }
            if (data.hasOwnProperty("resources")) {
                obj["resources"] = V1RunResources.constructFromObject(
                    data["resources"]
                );
            }
            ...
            if (data.hasOwnProperty("merge")) {
                obj["merge"] = ApiClient.convertToType(
                    data["merge"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["project"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `project` to be a primitive type in the JSON string but got " +
                    data["project"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["content"] instanceof String
            )
        ) {
            throw new Error(
        ...
        if (
            ...
            !(
                ...
                data["raw_content"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `raw_content` to be a primitive type in the JSON string but got " +
                    data["raw_content"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["readme"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `readme` to be a primitive type in the JSON string but got " +
                    data["readme"]
            );
        }
        ...
        if (data["status_conditions"]) {
            ...
            if (!Array.isArray(data["status_conditions"])) {
                throw new Error(
                    "Expected the field `status_conditions` to be an array in the JSON data but got " +
                        data["status_conditions"]
                );
            }
        ...
        if (!Array.isArray(data["contributors"])) {
            throw new Error(
                "Expected the field `contributors` to be an array in the JSON data but got " +
                    data["contributors"]
            );
        }
