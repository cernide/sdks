    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("earlyStopping")) {
                obj["earlyStopping"] = V1EarlyStopping.constructFromObject(
                    data["earlyStopping"]
                );
            }
            ...
            if (data.hasOwnProperty("operation")) {
                obj["operation"] = V1Operation.constructFromObject(
                    data["operation"]
                );
            }
            if (data.hasOwnProperty("compiledOperation")) {
                obj["compiledOperation"] =
                    V1CompiledOperation.constructFromObject(
                        data["compiledOperation"]
                    );
            }
            if (data.hasOwnProperty("schedule")) {
                obj["schedule"] = V1Schedule.constructFromObject(
                    data["schedule"]
                );
            }
            if (data.hasOwnProperty("connectionSchema")) {
                obj["connectionSchema"] =
                    V1ConnectionSchema.constructFromObject(
                        data["connectionSchema"]
                    );
            }
            if (data.hasOwnProperty("hpParams")) {
                obj["hpParams"] = V1HpParams.constructFromObject(
                    data["hpParams"]
                );
            }
            if (data.hasOwnProperty("reference")) {
                obj["reference"] = V1Reference.constructFromObject(
                    data["reference"]
                );
            }
            if (data.hasOwnProperty("artifactsMount")) {
                obj["artifactsMount"] = V1ArtifactsMount.constructFromObject(
                    data["artifactsMount"]
                );
            }
            if (data.hasOwnProperty("polyaxonSidecarContainer")) {
                obj["polyaxonSidecarContainer"] =
                    V1PolyaxonSidecarContainer.constructFromObject(
                        data["polyaxonSidecarContainer"]
                    );
            }
            if (data.hasOwnProperty("polyaxonInitContainer")) {
                obj["polyaxonInitContainer"] =
                    V1PolyaxonInitContainer.constructFromObject(
                        data["polyaxonInitContainer"]
                    );
            }
            if (data.hasOwnProperty("artifacs")) {
                obj["artifacs"] = V1ArtifactsType.constructFromObject(
                    data["artifacs"]
                );
            }
            ...
            if (data.hasOwnProperty("resource")) {
                obj["resource"] = V1ConnectionResource.constructFromObject(
                    data["resource"]
                );
            }
            if (data.hasOwnProperty("connection")) {
                obj["connection"] = V1ConnectionType.constructFromObject(
                    data["connection"]
                );
            }
            if (data.hasOwnProperty("eventType")) {
                obj["eventType"] = V1EventType.constructFromObject(
                    data["eventType"]
                );
            }
            if (data.hasOwnProperty("matrixKind")) {
                obj["matrixKind"] = V1MatrixKind.constructFromObject(
                    data["matrixKind"]
                );
            }
            if (data.hasOwnProperty("scheduleKind")) {
                obj["scheduleKind"] = V1ScheduleKind.constructFromObject(
                    data["scheduleKind"]
                );
            }
