    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("excluded_features")) {
                obj["excluded_features"] = ApiClient.convertToType(
                    data["excluded_features"],
                    ["String"]
                );
            }
            if (data.hasOwnProperty("excluded_runtimes")) {
                obj["excluded_runtimes"] = ApiClient.convertToType(
                    data["excluded_runtimes"],
                    ["String"]
                );
            }
            if (data.hasOwnProperty("archived_deletion_interval")) {
                obj["archived_deletion_interval"] = ApiClient.convertToType(
                    data["archived_deletion_interval"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("connections")) {
                obj["connections"] = ApiClient.convertToType(
                    data["connections"],
                    ["String"]
                );
            }
            if (data.hasOwnProperty("preset")) {
                obj["preset"] = ApiClient.convertToType(
                    data["preset"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("queues")) {
                obj["queues"] = ApiClient.convertToType(data["queues"], [
                    "String",
                ]);
            }
            if (data.hasOwnProperty("agents")) {
                obj["agents"] = ApiClient.convertToType(data["agents"], [
                    "String",
                ]);
            }
            if (data.hasOwnProperty("namespaces")) {
                obj["namespaces"] = ApiClient.convertToType(
                    data["namespaces"],
                    ["String"]
                );
            }
            if (data.hasOwnProperty("user_accesses")) {
                obj["user_accesses"] = ApiClient.convertToType(
                    data["user_accesses"],
                    [V1UserAccess]
                );
            }
            if (data.hasOwnProperty("teams")) {
                obj["teams"] = ApiClient.convertToType(data["teams"], [
                    "String",
                ]);
            }
            if (data.hasOwnProperty("projects")) {
                obj["projects"] = ApiClient.convertToType(data["projects"], [
                    "String",
                ]);
            }
            if (data.hasOwnProperty("connected_projects")) {
                obj["connected_projects"] = ApiClient.convertToType(
                    data["connected_projects"],
                    ["String"]
                );
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["uuid"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `uuid` to be a primitive type in the JSON string but got " +
                    data["uuid"]
            );
        }
        // ensure the json data is a string
        ...
        if (!Array.isArray(data["excluded_features"])) {
            throw new Error(
                "Expected the field `excluded_features` to be an array in the JSON data but got " +
                    data["excluded_features"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["excluded_runtimes"])) {
            throw new Error(
                "Expected the field `excluded_runtimes` to be an array in the JSON data but got " +
                    data["excluded_runtimes"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["connections"])) {
            throw new Error(
                "Expected the field `connections` to be an array in the JSON data but got " +
                    data["connections"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["preset"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `preset` to be a primitive type in the JSON string but got " +
                    data["preset"]
            );
        }
        // ensure the json data is an array
        ...
        if (!Array.isArray(data["queues"])) {
            throw new Error(
                "Expected the field `queues` to be an array in the JSON data but got " +
                    data["queues"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["agents"])) {
            throw new Error(
                "Expected the field `agents` to be an array in the JSON data but got " +
                    data["agents"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["namespaces"])) {
            throw new Error(
                "Expected the field `namespaces` to be an array in the JSON data but got " +
                    data["namespaces"]
            );
        }
        if (data["user_accesses"]) {
            ...
            if (!Array.isArray(data["user_accesses"])) {
                throw new Error(
                    "Expected the field `user_accesses` to be an array in the JSON data but got " +
                        data["user_accesses"]
                );
            }
        ...
        if (!Array.isArray(data["connected_projects"])) {
            throw new Error(
                "Expected the field `connected_projects` to be an array in the JSON data but got " +
                    data["connected_projects"]
            );
        }
