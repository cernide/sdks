...
class V1EventCurve {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("kind")) {
                obj["kind"] = V1EventCurveKind.constructFromObject(
                    data["kind"]
                );
            }
            ...
            if (data.hasOwnProperty("annotation")) {
                obj["annotation"] = ApiClient.convertToType(
                    data["annotation"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["x"])) {
            throw new Error(
                "Expected the field `x` to be an array in the JSON data but got " +
                    data["x"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["y"])) {
            throw new Error(
                "Expected the field `y` to be an array in the JSON data but got " +
                    data["y"]
            );
        }
        ...
        if (
            ...
            !(
                ...
                data["annotation"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `annotation` to be a primitive type in the JSON string but got " +
                    data["annotation"]
            );
        }
