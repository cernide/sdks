...
class V1DockerfileType {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("env")) {
                obj["env"] = ApiClient.convertToType(data["env"], {
                    String: "String",
                });
            }
            ...
            if (data.hasOwnProperty("post_run_copy")) {
                obj["post_run_copy"] = ApiClient.convertToType(
                    data["post_run_copy"],
                    [Object]
                );
            }
            ...
            if (data.hasOwnProperty("langEnv")) {
                obj["langEnv"] = ApiClient.convertToType(
                    data["langEnv"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("username")) {
                obj["username"] = ApiClient.convertToType(
                    data["username"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("filename")) {
                obj["filename"] = ApiClient.convertToType(
                    data["filename"],
                    "String"
                );
            }
            if (data.hasOwnProperty("workdir")) {
                obj["workdir"] = ApiClient.convertToType(
                    data["workdir"],
                    "String"
                );
            }
            if (data.hasOwnProperty("workdirPath")) {
                obj["workdirPath"] = ApiClient.convertToType(
                    data["workdirPath"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            throw new Error(
                "Expected the field `image` to be a primitive type in the JSON string but got " +
                    data["image"]
            );
        }
        ...
        if (!Array.isArray(data["path"])) {
            throw new Error(
                "Expected the field `path` to be an array in the JSON data but got " +
                    data["path"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["copy"])) {
            throw new Error(
                "Expected the field `copy` to be an array in the JSON data but got " +
                    data["copy"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["post_run_copy"])) {
            throw new Error(
                "Expected the field `post_run_copy` to be an array in the JSON data but got " +
                    data["post_run_copy"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["run"])) {
            throw new Error(
                "Expected the field `run` to be an array in the JSON data but got " +
                    data["run"]
            );
        }
        // ensure the json data is a string
        if (
            data["langEnv"] &&
            !(
                typeof data["langEnv"] === "string" ||
                data["langEnv"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `langEnv` to be a primitive type in the JSON string but got " +
                    data["langEnv"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            ...
            !(
                ...
                data["workdir"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `workdir` to be a primitive type in the JSON string but got " +
                    data["workdir"]
            );
        }
        // ensure the json data is a string
        if (
            data["workdirPath"] &&
            !(
                typeof data["workdirPath"] === "string" ||
                data["workdirPath"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `workdirPath` to be a primitive type in the JSON string but got " +
                    data["workdirPath"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["shell"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `shell` to be a primitive type in the JSON string but got " +
                    data["shell"]
            );
        }
