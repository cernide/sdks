    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("bucket")) {
                obj["bucket"] = ApiClient.convertToType(
                    data["bucket"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["bucket"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `bucket` to be a primitive type in the JSON string but got " +
                    data["bucket"]
            );
        }
        // ensure the json data is a string
        if (
            data["blob"] &&
            !(
                typeof data["blob"] === "string" ||
                data["blob"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `blob` to be a primitive type in the JSON string but got " +
                    data["blob"]
            );
        }
