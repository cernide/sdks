...
class V1IO {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("isOptional")) {
                obj["isOptional"] = ApiClient.convertToType(
                    data["isOptional"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("isList")) {
                obj["isList"] = ApiClient.convertToType(
                    data["isList"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("isFlag")) {
                obj["isFlag"] = ApiClient.convertToType(
                    data["isFlag"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("argFormat")) {
                obj["argFormat"] = ApiClient.convertToType(
                    data["argFormat"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("toInit")) {
                obj["toInit"] = ApiClient.convertToType(
                    data["toInit"],
                    "Boolean"
                );
            }
            ...
            if (data.hasOwnProperty("validation")) {
                obj["validation"] = V1Validation.constructFromObject(
                    data["validation"]
                );
            }
            if (data.hasOwnProperty("delayValidation")) {
                obj["delayValidation"] = ApiClient.convertToType(
                    data["delayValidation"],
                    "Boolean"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["argFormat"] &&
            !(
                typeof data["argFormat"] === "string" ||
                data["argFormat"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `argFormat` to be a primitive type in the JSON string but got " +
                    data["argFormat"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            data["toEnv"] &&
            !(
                typeof data["toEnv"] === "string" ||
                data["toEnv"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `toEnv` to be a primitive type in the JSON string but got " +
                    data["toEnv"]
            );
        }
