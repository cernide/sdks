...
class V1ServiceAccount {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("scopes")) {
                obj["scopes"] = ApiClient.convertToType(data["scopes"], [
                    "String",
                ]);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["scopes"])) {
            throw new Error(
                "Expected the field `scopes` to be an array in the JSON data but got " +
                    data["scopes"]
            );
        }
        // ensure the json data is an array
        if (!Array.isArray(data["services"])) {
            throw new Error(
                "Expected the field `services` to be an array in the JSON data but got " +
                    data["services"]
            );
        }
