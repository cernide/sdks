...
class V1SectionSpec {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("is_minimized")) {
                obj["is_minimized"] = ApiClient.convertToType(
                    data["is_minimized"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("is_frozen")) {
                obj["is_frozen"] = ApiClient.convertToType(
                    data["is_frozen"],
                    "Boolean"
                );
            }
            ...
            if (data.hasOwnProperty("height")) {
                obj["height"] = ApiClient.convertToType(
                    data["height"],
                    "Number"
                );
            }
            ...
            if (data.hasOwnProperty("smoothing")) {
                obj["smoothing"] = ApiClient.convertToType(
                    data["smoothing"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("ignore_outliers")) {
                obj["ignore_outliers"] = ApiClient.convertToType(
                    data["ignore_outliers"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("sample_size")) {
                obj["sample_size"] = ApiClient.convertToType(
                    data["sample_size"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("widgets")) {
                obj["widgets"] = ApiClient.convertToType(data["widgets"], [
                    Object,
                ]);
            }
            if (data.hasOwnProperty("page_index")) {
                obj["page_index"] = ApiClient.convertToType(
                    data["page_index"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("page_size")) {
                obj["page_size"] = ApiClient.convertToType(
                    data["page_size"],
                    "Number"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["xaxis"] &&
            !(
                typeof data["xaxis"] === "string" ||
                data["xaxis"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `xaxis` to be a primitive type in the JSON string but got " +
                    data["xaxis"]
            );
        }
        ...
        if (!Array.isArray(data["widgets"])) {
            throw new Error(
                "Expected the field `widgets` to be an array in the JSON data but got " +
                    data["widgets"]
            );
        }
