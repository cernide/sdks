    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("frequency")) {
                obj["frequency"] = ApiClient.convertToType(
                    data["frequency"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["view"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `view` to be a primitive type in the JSON string but got " +
                    data["view"]
            );
        }
        // ensure the json data is a string
        if (
            data["trunc"] &&
            !(
                typeof data["trunc"] === "string" ||
                data["trunc"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `trunc` to be a primitive type in the JSON string but got " +
                    data["trunc"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            ...
            !(
                ...
                data["frequency"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `frequency` to be a primitive type in the JSON string but got " +
                    data["frequency"]
            );
        }
