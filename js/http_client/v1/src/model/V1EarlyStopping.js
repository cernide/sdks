    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("median")) {
                obj["median"] = V1MedianStoppingPolicy.constructFromObject(
                    data["median"]
                );
            }
            if (data.hasOwnProperty("diff")) {
                obj["diff"] = V1DiffStoppingPolicy.constructFromObject(
                    data["diff"]
                );
            }
            if (data.hasOwnProperty("truncation")) {
                obj["truncation"] =
                    V1TruncationStoppingPolicy.constructFromObject(
                        data["truncation"]
                    );
            }
            if (data.hasOwnProperty("metric")) {
                obj["metric"] = V1MetricEarlyStopping.constructFromObject(
                    data["metric"]
                );
            }
            if (data.hasOwnProperty("failure")) {
                obj["failure"] = V1FailureEarlyStopping.constructFromObject(
                    data["failure"]
                );
            }
        }
