    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("entity")) {
                obj["entity"] = ApiClient.convertToType(
                    data["entity"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("condition")) {
                obj["condition"] = V1StageCondition.constructFromObject(
                    data["condition"]
                );
            }
        }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["entity"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `entity` to be a primitive type in the JSON string but got " +
                    data["entity"]
            );
        }
        // ensure the json data is a string
