...
class V1Init {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("artifacts")) {
                obj["artifacts"] = V1ArtifactsType.constructFromObject(
                    data["artifacts"]
                );
            }
            ...
            if (data.hasOwnProperty("dockerfile")) {
                obj["dockerfile"] = V1DockerfileType.constructFromObject(
                    data["dockerfile"]
                );
            }
            ...
            if (data.hasOwnProperty("tensorboard")) {
                obj["tensorboard"] = V1TensorboardType.constructFromObject(
                    data["tensorboard"]
                );
            }
            if (data.hasOwnProperty("lineageRef")) {
                obj["lineageRef"] = ApiClient.convertToType(
                    data["lineageRef"],
                    "String"
                );
            }
            if (data.hasOwnProperty("artifactRef")) {
                obj["artifactRef"] = ApiClient.convertToType(
                    data["artifactRef"],
                    "String"
                );
            }
            if (data.hasOwnProperty("modelRef")) {
                obj["modelRef"] = ApiClient.convertToType(
                    data["modelRef"],
                    "String"
                );
            }
            ...
            if (data.hasOwnProperty("container")) {
                obj["container"] = ApiClient.convertToType(
                    data["container"],
                    Object
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data["paths"])) {
            throw new Error(
                "Expected the field `paths` to be an array in the JSON data but got " +
                    data["paths"]
            );
        }
        ...
        if (
            data["lineageRef"] &&
            !(
                typeof data["lineageRef"] === "string" ||
                data["lineageRef"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `lineageRef` to be a primitive type in the JSON string but got " +
                    data["lineageRef"]
            );
        }
        // ensure the json data is a string
        if (
            ...
            !(
                ...
                data["artifactRef"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `artifactRef` to be a primitive type in the JSON string but got " +
                    data["artifactRef"]
            );
        }
        // ensure the json data is a string
        if (
            data["modelRef"] &&
            !(
                typeof data["modelRef"] === "string" ||
                data["modelRef"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `modelRef` to be a primitive type in the JSON string but got " +
                    data["modelRef"]
            );
        }
        // ensure the json data is a string
