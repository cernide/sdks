    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("hubs")) {
                obj["hubs"] = ApiClient.convertToType(data["hubs"], [
                    V1SettingsCatalog,
                ]);
            }
            if (data.hasOwnProperty("registries")) {
                obj["registries"] = ApiClient.convertToType(
                    data["registries"],
                    [V1SettingsCatalog]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (data["hubs"]) {
            ...
            if (!Array.isArray(data["hubs"])) {
                throw new Error(
                    "Expected the field `hubs` to be an array in the JSON data but got " +
                        data["hubs"]
                );
            }
        ...
        if (data["registries"]) {
            ...
            if (!Array.isArray(data["registries"])) {
                throw new Error(
                    "Expected the field `registries` to be an array in the JSON data but got " +
                        data["registries"]
                );
            }
