    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("bucketConnection")) {
                obj["bucketConnection"] =
                    V1BucketConnection.constructFromObject(
                        data["bucketConnection"]
                    );
            }
            if (data.hasOwnProperty("hostPathConnection")) {
                obj["hostPathConnection"] =
                    V1HostPathConnection.constructFromObject(
                        data["hostPathConnection"]
                    );
            }
            if (data.hasOwnProperty("claimConnection")) {
                obj["claimConnection"] = V1ClaimConnection.constructFromObject(
                    data["claimConnection"]
                );
            }
            if (data.hasOwnProperty("hostConnection")) {
                obj["hostConnection"] = V1HostConnection.constructFromObject(
                    data["hostConnection"]
                );
            }
            if (data.hasOwnProperty("gitConnection")) {
                obj["gitConnection"] = V1GitConnection.constructFromObject(
                    data["gitConnection"]
                );
            }
        }
