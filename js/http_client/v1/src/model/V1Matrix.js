    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("random")) {
                obj["random"] = V1RandomSearch.constructFromObject(
                    data["random"]
                );
            }
            ...
            if (data.hasOwnProperty("hyperband")) {
                obj["hyperband"] = V1Hyperband.constructFromObject(
                    data["hyperband"]
                );
            }
            ...
            if (data.hasOwnProperty("hyperopt")) {
                obj["hyperopt"] = V1Hyperopt.constructFromObject(
                    data["hyperopt"]
                );
            }
            if (data.hasOwnProperty("iterative")) {
                obj["iterative"] = V1Iterative.constructFromObject(
                    data["iterative"]
                );
            }
