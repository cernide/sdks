    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("imageTag")) {
                obj["imageTag"] = ApiClient.convertToType(
                    data["imageTag"],
                    "String"
                );
            }
            if (data.hasOwnProperty("imagePullPolicy")) {
                obj["imagePullPolicy"] = ApiClient.convertToType(
                    data["imagePullPolicy"],
                    "String"
                );
            }
            if (data.hasOwnProperty("sleepInterval")) {
                obj["sleepInterval"] = ApiClient.convertToType(
                    data["sleepInterval"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("syncInterval")) {
                obj["syncInterval"] = ApiClient.convertToType(
                    data["syncInterval"],
                    "Number"
                );
            }
            if (data.hasOwnProperty("monitorLogs")) {
                obj["monitorLogs"] = ApiClient.convertToType(
                    data["monitorLogs"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("monitorSpec")) {
                obj["monitorSpec"] = ApiClient.convertToType(
                    data["monitorSpec"],
                    "Boolean"
                );
            }
            if (data.hasOwnProperty("resources")) {
                obj["resources"] = ApiClient.convertToType(
                    data["resources"],
                    Object
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["imageTag"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `imageTag` to be a primitive type in the JSON string but got " +
                    data["imageTag"]
            );
        }
        // ensure the json data is a string
        if (
            data["imagePullPolicy"] &&
            !(
                typeof data["imagePullPolicy"] === "string" ||
                data["imagePullPolicy"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `imagePullPolicy` to be a primitive type in the JSON string but got " +
                    data["imagePullPolicy"]
            );
        }
