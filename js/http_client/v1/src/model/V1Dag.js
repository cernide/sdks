    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("operations")) {
                obj["operations"] = ApiClient.convertToType(
                    data["operations"],
                    [V1Operation]
                );
            }
            if (data.hasOwnProperty("components")) {
                obj["components"] = ApiClient.convertToType(
                    data["components"],
                    [V1Component]
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (data["operations"]) {
            ...
            if (!Array.isArray(data["operations"])) {
                throw new Error(
                    "Expected the field `operations` to be an array in the JSON data but got " +
                        data["operations"]
                );
            }
        ...
        if (data["components"]) {
            ...
            if (!Array.isArray(data["components"])) {
                throw new Error(
                    "Expected the field `components` to be an array in the JSON data but got " +
                        data["components"]
                );
            }
