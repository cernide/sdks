...
class V1HostPathConnection {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty("hostPath")) {
                obj["hostPath"] = ApiClient.convertToType(
                    data["hostPath"],
                    "String"
                );
            }
    ...
    static validateJSON(data) {
        ...
        if (
            data["hostPath"] &&
            !(
                typeof data["hostPath"] === "string" ||
                data["hostPath"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `hostPath` to be a primitive type in the JSON string but got " +
                    data["hostPath"]
            );
        }
        // ensure the json data is a string
