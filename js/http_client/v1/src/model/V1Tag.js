    ...
    static validateJSON(data) {
        ...
        if (
            ...
            !(
                ...
                data["color"] instanceof String
            )
        ) {
            throw new Error(
                "Expected the field `color` to be a primitive type in the JSON string but got " +
                    data["color"]
            );
        }
        // ensure the json data is a string
        ...
        if (
            ...
            throw new Error(
                "Expected the field `icon` to be a primitive type in the JSON string but got " +
                    data["icon"]
            );
        }
